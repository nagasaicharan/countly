...
/***
 * @module api/utils/userovo-request
 */
...
var initParams = function(uri, options, callback, userovoConfig) {
...
module.exports = function(userovoConfig) {
    // Return the request function
    // eslint-disable-next-line require-jsdoc
    function requestFunction(uri, options, callback, config = userovoConfig) {
    ...
    // eslint-disable-next-line require-jsdoc
    function post(uri, options, callback, config = userovoConfig) {
    ...
    function get(uri, options, callback, config = userovoConfig) {
