/**
* Module to abstract storing files on hard drive or in a shared system between multiple userovo instances, currently based on GridFS
* @module api/utils/userovoFs
*/

/** @lends module:api/utils/userovoFs */
var userovoFs = {};
...
(function(ob) {
    ...
    * @param {function} callback - function called when we have result, providing error object as first param and id as second
    * @example
    * userovoFs.getId("test", "./CHANGELOG.md", function(err, exists){
    *   if(exists)
    ...
    * @example
    * userovoFs.exists("test", "./CHANGELOG.md", function(err, exists){
    *   if(exists)
    *       console.log("File exists");
    * });
    */
    ...
    * @example
    * userovoFs.saveFile("test", "./CHANGELOG.md", function(err){
    ...
    * @param {function} callback - function called when saving was completed or errored, providing error object as first param
    * @example
    * userovoFs.saveData("test", "test.text", "some\nmultiline\ntest", function(err){
    ...
    * @param {function} callback - function called when saving was completed or errored, providing error object as first param
    * @example
    * userovoFs.saveStream("test", "AGPLv3", fs.createReadStream("AGPLv3"), function(err){
    ...
    * @example
    * userovoFs.rename("test", "AGPLv3", "LICENSE.md", function(err){
    ...
    */
     ...
     * @example
     * userovoFs.gridfs.updateFileById("test", "66d6c2d770434130c03b7dae", { filename: "newname.png", "metadata.tags": "newtag" }, function(err){
    ...
    * @example
    * userovoFs.deleteFile("test", "AGPLv3", function(err){
    *   console.log("Finished", err);
    * });
    */
    ...
    * @param {function} callback - function called when deleting was completed or errored, providing error object as first param
    * @example
    * userovoFs.deleteAll("test", function(err){
    *   console.log("Finished", err);
    * });
    */
    ...
    * @example
    * userovoFs.getStream("test", "CHANGELOG.md", function(err, stream){
    ...
    * @example
    * userovoFs.getData("test", "AGPLv3", function(err, data){
    ...
    * @example
    * userovoFs.getSize("test", "AGPLv3", function(err, size){
    ...
    * @param {function} callback - function called when retrieving file size was completed or errored, providing error object as first param and file size as second
    * @example
    * userovoFs.getStats("test", "AGPLv3", function(err, stats){
    ...
    * @param {function} callback - function called when retrieving stream was completed or errored, providing error object as first param and filedata as second
    * @example
    * userovoFs.getDataById("test", "AGPLv3", function(err, data){
    *   console.log("Retrieved", err, data); 
    * });
    */
    ...
    * @param {function} callback - function called when retrieving stream was completed or errored, providing error object as first param and filedata as second
    * @example
    * userovoFs.getStreamById("test", "AGPLv3", function(err, data){
    *   console.log("Retrieved", err, data); 
    * });
    */
    ...
    * @param {function} callback - function called when deleting was completed or errored, providing error object as first param
    * @example
    * userovoFs.deleteFileById("test", "AGPLv3", function(err){
    *   console.log("Finished", err);
    * });
    */
    ...
    * @param {function} callback - function called when deleting was completed or errored, providing error object as first param
    * @example
    * userovoFs.clearFile("test", "AGPLv3", function(err){
    *   console.log("Finished", err);
    * });
    */
...
* @param {function} callback - function called when saving was completed or errored, providing error object as first param
* @example
* userovoFs.saveFile("test", "./CHANGELOG", "./CHANGELOG.md", function(err){
*   console.log("Storing file finished", err);
* });
*/
userovoFs.saveFile = function() {
    var handler = this[config.fileStorage] || this.fs;
...
* @param {object} dbCon - database connection
*/
userovoFs.setHandler = function(dbCon) {
    var handler = this[config.fileStorage] || this.fs;
...
**/
userovoFs.type = config.fileStorage || "fs";

module.exports = userovoFs;