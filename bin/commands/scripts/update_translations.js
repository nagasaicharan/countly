...
var request = require("userovo-request")(manager.getConfig("security"));

var header = "# DO NOT EDIT THIS FILE AS IT WILL BE OVERRIDEN DURING TRANSLATION SYNC\n" +
             "# IF YOU WOULD LIKE TO HELP USEROVO TO BE TRANSLATED INTO YOUR LANGUAGE\n" +
             "# PLEASE VISIT https://www.transifex.com/osoner/userovo\n\n";
...
var auth = "Basic " + Buffer.from("userovo:userovo").toString("base64");
...
function getFile(resource, language) {
    ...
    fs.stat(location, function(err, stats) {
        ...
        makeRequest("https://www.transifex.com/api/2/project/userovo/resource/" + resource.slug + "/stats/" + language.language_code + "/", true, function(err, stats) {
            if (err) {
            ...
            makeRequest("https://www.transifex.com/api/2/project/userovo/resource/" + resource.slug + "/translation/" + language.language_code + "/", false, function(err, file) {
                if (err) {
...
manager.dbConnection().then((db) => {
    manager.loadConfigs(db, function() {
        if (!manager.getConfig("api").offline_mode) {
            //get resources
            // Requesting this resource, response data is mandatory.
            makeRequest("https://www.transifex.com/api/2/project/userovo/resources/", false, function(err, resources) {
                if (err) {
