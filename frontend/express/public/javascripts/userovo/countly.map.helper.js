/* global userovoGlobal, google, _, jQuery, userovoLocation*/
(function(userovoMapHelper) {
    ...
    userovoMapHelper.drawGeoChart = function(options, locationData) {
        if (options) {
    ...
    */
    function draw() {
        ...
        chartData.rows = _.map(_mapData, function(value) {
            ...
            value.country = userovoLocation.getCountryName(value.country);
...
}(window.userovoMapHelper = window.userovoMapHelper || {}));