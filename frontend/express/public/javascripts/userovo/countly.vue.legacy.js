/* global userovoCommon, moment, jQuery*/

(function(UserovoVueComponents, $) {

    /**
     * CLY Select list VueJS component. It supports big lists and search.
     */
    UserovoVueComponents.selectList = {
     ...
     * CLY Date Picker
     */
    UserovoVueComponents.datePicker = {
        ...
        computed: {
            formatDate: function() {
                if (this.value) {
                    return userovoCommon.formatDate(moment(this.value * 1000), "DD MMMM, YYYY");
                }
                else {
                    return null;
                }
        ...
        mounted: function() {
            ...
            datePickerDOM.find(".calendar").datepicker({
                ...
                onSelect: function(selectedDate) {
                    ...
                    var tzCorr = userovoCommon.getOffsetCorrectionForTimestamp(selectedTimestamp);
            ...
            datePickerDOM.find(".calendar").datepicker("option", $.datepicker.regional[userovoCommon.BROWSER_LANG]);
     ...
     */
    UserovoVueComponents.datePickerExtended = {
            ...
            formatDate: function() {
                if (Array.isArray(this.value)) {
                    return this.value.map(function(point) {
                        return userovoCommon.formatDate(moment(point), "DD MMMM, YYYY");
                    }).join(" - ");
                }
                else if (this.value) {
                    return userovoCommon.formatDate(moment(this.value), "DD MMMM, YYYY");
                }
                else {
                    return null;
                }
...
}(window.UserovoVueComponents = window.UserovoVueComponents || {}, jQuery));
