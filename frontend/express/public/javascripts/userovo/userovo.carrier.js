...
(function() {
    ...
    */
    ...
    window.userovoCarrier = window.userovoCarrier || {};
    window.userovoCarrier.getCarrierCodeName = getCarrierCodeName;
    window.userovoCarrier.getCodesFromName = getCodesFromName;

    UserovoHelpers.createMetricModel(window.userovoCarrier, {name: "carriers", estOverrideMetric: "carriers"}, jQuery, getCarrierCodeName);
}());