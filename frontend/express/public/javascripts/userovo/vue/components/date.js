/* global Vue, ELEMENT, moment, userovoCommon, _, CV, userovoPresets */
...
(function(userovoVue) {
    ...
    var availableShortcuts = {
        "yesterday": {
            label: userovoVue.i18n("common.yesterday"),
            value: "yesterday",
            getRange: function() {
        ...
        "hour": {
            label: userovoVue.i18n("common.today"),
            value: "hour",
            getRange: function() {
        ...
        "7days": {
            label: userovoVue.i18n("taskmanager.last-7days"),
            value: "7days",
            getRange: function() {
        ...
        "30days": {
            label: userovoVue.i18n("taskmanager.last-30days"),
            value: "30days",
            getRange: function() {
        ...
        "60days": {
            label: userovoVue.i18n("taskmanager.last-60days"),
            value: "60days",
            getRange: function() {
        ...
        "0days": {
            label: userovoVue.i18n("common.all-time"),
            value: "0days",
            getRange: function() {
    ...
    function getRangeLabel(state, type) {
        if (state.selectedShortcut === "0days") {
            return userovoVue.i18n("common.all-time");
        }
    ...
    Vue.component("cly-date-picker", userovoVue.components.create({
        mixins: [
            _mixins.i18n,
            InputControlsMixin,
            CalendarsMixin,
            ...
            'value': {
                ...
                handler: function(newVal) {
                    ...
                    if (this.isGlobalDatePicker) {
                        try {
                            const latestDateRange = JSON.parse(localStorage.getItem("userovo_date_range_mode_" + userovoCommon.ACTIVE_APP_ID));
        ...
        methods: {
            ...
            valueToInputState: function(value) {
                ...
                if (this.allowPresets) {
                    if (this.selectedPreset) {
                        ...
                        userovoPresets.refreshGlobalDatePreset();
                        let globalPreset = userovoPresets.getGlobalDatePreset();
                ...
                var meta = userovoCommon.convertToTimePeriodObj(value),
                    now = moment().toDate(),
                    state = {
                        selectedShortcut: null,
                        customRangeSelection: true,
            ...
            handleDropdownShow: function() {
                this.isVisible = true;
                if (this.isGlobalDatePicker) {
                    this.presetSelection = this.allowPresets && userovoPresets.getGlobalDatePresetId() !== null;
                }
                else {
                ...
                if (this.isGlobalDatePicker) {
                    try {
                        var storedDateItems = JSON.parse(localStorage.getItem("userovo_date_range_mode_" + userovoCommon.ACTIVE_APP_ID));
            ...
            doCommit: function(value, isShortcut, isPreset) {
                if (value) {
                    ...
                    if (this.isGlobalDatePicker) {
                        if (!isShortcut) {
                            localStorage.setItem("userovo_date_range_mode_" + userovoCommon.ACTIVE_APP_ID, JSON.stringify({"rangeMode": this.rangeMode, "tableType": this.tableType}));
                        }
                        else {
                            localStorage.setItem("userovo_date_range_mode_" + userovoCommon.ACTIVE_APP_ID, JSON.stringify({"rangeMode": "inBetween", "tableType": this.tableType}));
                        }
                    }
                    ...
                    if (this.allowPresets && !isPreset) {
                        ...
                        if (this.isGlobalDatePicker) {
                            userovoPresets.clearGlobalDatePresetId();
                        }
                    }
        ...
        template: CV.T('/javascripts/userovo/vue/templates/datepicker.html')
    }));

    var globalDatepicker = userovoBaseComponent.extend({
        computed: {
            globalDate:
            {
                get: function() {
                    return this.$store.getters["userovoCommon/period"];
                },
                set: function(newVal) {
                    userovoCommon.setPeriod(newVal);
                }
            }
        },
        methods: {
    ...
    */
    ...
    userovoVue.getPeriodLabel = getPeriodLabel;
