...
(function(userovoVue) {
    ...
    Vue.component("cly-dialog", userovoVue.components.create({
        props: {
            title: {
                type: String,
                required: false,
    ...
    Vue.component("cly-confirm-dialog", userovoVue.components.create({
        props: {
    ...
    Vue.component("cly-message-dialog", userovoVue.components.create({
        props: {
            title: {type: String, required: true},
    ...
    Vue.component("cly-form-dialog", userovoVue.components.create(
        // @vue/component
        {
            inheritAttrs: false,
            mixins: [
            ...
            template: CV.T('/javascripts/userovo/vue/templates/formdialog.html')
        }
    ));
    ...
    userovoVue.mixins.hasFormDialogs = hasFormDialogsMixin;
