...
(function(userovoVue) {
    ...
    Vue.component("cly-drawer", userovoVue.components.create(
        // @vue/component
        {
            inheritAttrs: false,
            mixins: [
            ...
            template: CV.T('/javascripts/userovo/vue/templates/drawer.html')
        }
    ));
    ...
    userovoVue.mixins.hasDrawers = hasDrawersMixin;
    userovoVue.mixins.hasDrawersMethods = hasDrawersMethodsMixin;
