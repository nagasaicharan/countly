...
(function(userovoVue) {
    ...
    Vue.component("cly-form", userovoBaseComponent.extend({
    ...
    Vue.component("cly-form-field-group", userovoBaseComponent.extend({
        props: {
            label: String,
            highlight: {
                type: Boolean,
    ...
    Vue.component("cly-form-field", userovoBaseComponent.extend({
        props: {
    ...
    Vue.component("cly-inline-form-field", userovoVue.components.BaseComponent.extend({
        props: {
            label: String,
            help: String,
    ...
    Vue.component("cly-form-field-checklistbox", userovoBaseComponent.extend({
        mixins: [userovoVue.mixins.i18n],
        props: {
            value: { type: Array },
            name: { type: String },
    ...
    userovoVue.mixins.MultiStepForm = MultiStepFormMixin;
