/* global Vue UserovoHelpers userovoCMS $ */

(function(userovoVue) {

    var userovoBaseComponent = userovoVue.components.BaseComponent;

    Vue.component("cly-guide", userovoBaseComponent.extend({
        props: {
            tooltip: {
                type: Object,
                default: function() {
    ...
    Vue.component("cly-header", userovoBaseComponent.extend({
        props: {
            title: String,
            backlink: {
                type: Object,
    ...
    var PersistentNotifications = {
        ...
        computed: {
            persistentNotifications: function() {
                return this.$store.state.userovoCommon.persistentNotifications;
            },
    ...
    Vue.component("cly-main", userovoBaseComponent.extend({
    ...
    Vue.component("cly-section", userovoBaseComponent.extend({
        props: {
            title: String,
            autoGap: {
                type: Boolean,
    ...
    Vue.component("cly-sub-section", userovoBaseComponent.extend({
    ...
    userovoVue.ModalManager = _ModalManager;
