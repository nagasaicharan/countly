/* global Vue, Backbone, app, userovoGlobal, CV */

(function(userovoVue) {

    var userovoBaseComponent = userovoVue.components.BaseComponent;

    Vue.component("cly-tabs", userovoBaseComponent.extend({
        props: {
            value: String,
            routePattern: String,
            routeKey: String,
    ...
    */
    Vue.component("cly-dynamic-tabs", userovoBaseComponent.extend({
        data: function() {
            return {
                apps: userovoGlobal.apps
            };
        },
