/* global Vue, Vuex, _, userovoGlobal, CV, app */
...
(function(userovoVue) {
    ...
    var _dataTableAdapters = {
        ...
        toStandardResponse: function(response, requestOptions) {
            ...
            if (Object.prototype.hasOwnProperty.call(requestOptions, "url")) {
                ...
                pairs.push("api_key=" + userovoGlobal.member.api_key);
    ...
    userovoVue.vuex.Module = VuexModule;
    userovoVue.vuex.MutableTable = MutableTable;
    userovoVue.vuex.ServerDataTable = ServerDataTable;
    userovoVue.vuex.getServerDataSource = getServerDataSource;
    userovoVue.vuex.getLocalStore = getLocalStore;

    var FetchMixin = function() {
        var userovoFetchState = function() {
            return {
                hasError: false,
                error: null,
                isLoading: false
        ...
        var userovoFetchGetters = {
            isLoading: function(state) {
                return state.isLoading;
            }
        };

        return VuexModule('userovoFetch', {
            namespaced: false,
            state: userovoFetchState,
            actions: userovoFetchActions,
            getters: userovoFetchGetters,
            mutations: userovoFetchMutations
        });
    };
    userovoVue.vuex.FetchMixin = FetchMixin;
