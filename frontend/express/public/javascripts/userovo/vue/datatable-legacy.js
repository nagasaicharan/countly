/* global jQuery, Vue, moment, userovoCommon, userovoGlobal, UserovoHelpers, _ */
...
(function(userovoVue, $) {
    ...
    var clyDataTableControls = userovoBaseComponent.extend({
        mixins: [
            _mixins.i18n
        ],
    ...
    var clyDataTableRowOptions = userovoBaseComponent.extend({
        props: {
            items: {
                type: Array
            },
    ...
    Vue.component("cly-datatable", userovoBaseComponent.extend({
        mixins: [
            _mixins.i18n
        ],
        inheritAttrs: false,
    ...
    Vue.component("cly-datatable-detail-toggler", userovoBaseComponent.extend({
        props: {
            scope: {
                type: Object
            }
    ...
    Vue.component("cly-datatable-options", userovoBaseComponent.extend({
        props: {
            scope: {
                type: Object
            }
