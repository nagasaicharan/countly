/* global Vue, jQuery, _, userovoCommon, UserovoHelpers */
...
(function(userovoVue, $) {
    ...
    */
    ...
    Vue.component("cly-panel", userovoBaseComponent.extend(
        // @vue/component
        {
            props: {
    ...
    */
    ...
    Vue.component("cly-radio", userovoBaseComponent.extend(
        // @vue/component
        {
            props: {
    ...
    Vue.component("cly-generic-radio", userovoBaseComponent.extend(
        // @vue/component
        {
            props: {
                value: {required: true, default: -1, type: [ String, Number ]},
    ...
    Vue.component("cly-text-field", userovoBaseComponent.extend(
        // @vue/component
        {
            mixins: [
                _mixins.i18n
            ...
            computed: {
                defaultListeners: function() {
                    return UserovoHelpers.objectWithoutProperties(this.$listeners, ["input"]);
                },
    ...
    Vue.component("cly-check-list", userovoBaseComponent.extend(
        // @vue/component
        {
            props: {
                value: {
    ...
    Vue.component("cly-button", userovoBaseComponent.extend(
        // @vue/component
        {
            props: {
    ...
    Vue.component("cly-text-area", userovoBaseComponent.extend(
        // @vue/component
        {
            props: {
                value: {required: true, type: [ String, Number ], default: ''}
    ...
    Vue.component("cly-select-n", userovoBaseComponent.extend(
        // @vue/component
        {
            mixins: [
                _mixins.i18n
    ...
    */
    ...
    Vue.component("cly-menubox", userovoBaseComponent.extend({
    ...
    Vue.component("cly-button-menu", userovoBaseComponent.extend({
    ...
    */
    ...
    Vue.component("cly-time-graph-w", userovoBaseComponent.extend(
        // @vue/component
        {
            mixins: [
                _mixins.i18n
            ...
            methods: {
                refresh: function() {
                    ...
                    userovoCommon.drawTimeGraph(points,
                        $(this.$refs.container),
    ...
    Vue.component("cly-graph-w", userovoBaseComponent.extend(
        // @vue/component
        {
            mixins: [
                _mixins.i18n
            ...
            methods: {
                refresh: function() {
                    ...
                    userovoCommon.drawGraph(this.dataPoints,
                        $(this.$refs.container),
                        this.graphType,
                        this.options);
                }
