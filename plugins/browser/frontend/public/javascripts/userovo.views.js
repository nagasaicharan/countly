/* global userovoVue,CV,userovoCommon*/

(function() {
    var FEATURE_NAME = 'browser';
    var AppBrowserView = userovoVue.views.create({
                ...
                browserTabs: [
                    {
                        ...
                        component: userovoVue.views.create({
                            ...
                            computed: {
                                appBrowser: function() {
                                    return this.$store.state.userovoDevicesAndTypes.appBrowser;
                                },
                                appBrowserRows: function() {
                                    return this.appBrowser.chartData;
                                },
                                isLoading: function() {
                                    return this.$store.state.userovoDevicesAndTypes.browserLoading;
                                }
                            },
                            methods: {
                    ...
                    },
                    {
                        ...
                        component: userovoVue.views.create({
                            ...
                            computed: {
                                ...
                                selectedBrowser: {
                                    set: function(value) {
                                        this.$store.dispatch('userovoDevicesAndTypes/onSetSelectedBrowser', value);
                                    },
                                    get: function() {
                                        return this.$store.state.userovoDevicesAndTypes.selectedBrowser;
                                    }
                                }
                            },
                            watch: {
                            ...
                            methods: {
                                calculateVersions: function(newValue) {
                                    if (newValue) {
                                        this.$store.dispatch('userovoDevicesAndTypes/onSetSelectedBrowser', newValue);
                                    }
                                    else {
                                        this.selectedBrowser = this.appBrowser.versions[0].label;
                                        this.$store.dispatch('userovoDevicesAndTypes/onSetSelectedBrowser', this.selectedBrowser);
                                    }
        ...
        mounted: function() {
            this.$store.dispatch('userovoDevicesAndTypes/fetchBrowser');
        },
        methods: {
            refresh: function(force) {
                if (force) {
                    this.$store.dispatch('userovoDevicesAndTypes/fetchBrowser', true);
                }
                else {
                    this.$store.dispatch('userovoDevicesAndTypes/fetchBrowser', false);
                }
            },
        ...
        computed: {
            selectedProperty: {
                set: function(value) {
                    this.$store.dispatch('userovoDevicesAndTypes/onSetSelectedProperty', value);
                },
                get: function() {
                    return this.$store.state.userovoDevicesAndTypes.selectedProperty;
                }
            },
            ...
            appResolution: function() {
                return this.$store.state.userovoDevicesAndTypes.appResolution;
            },
            ...
            browserItems: function() {
                var display = [];
                var property = this.$store.state.userovoDevicesAndTypes.selectedProperty;
    ...
    userovoVue.container.registerTab("/analytics/technology", {
        type: "web",
        priority: 6,
        name: "browsers",
