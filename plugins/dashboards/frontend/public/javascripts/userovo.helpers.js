/*global userovoVue, CV, Vue, userovoCommon, userovoGlobal, userovoDashboards, moment, userovoAuth*/
...
(function() {
    ...
    var MetricComponent = userovoVue.views.create({
    ...
    var DisplayTypeComponent = userovoVue.views.create({
    ...
    var BreakdownComponent = userovoVue.views.create({
        template: CV.T('/dashboards/templates/helpers/drawer/breakdown.html'),
        mixins: [userovoVue.mixins.customDashboards.apps],
        props: {
            appId: {
                type: String,
                default: ""
            ...
            breakdowns: function() {
                ...
                case "session":
                    ...
                    if (app && app.type) {
                        ...
                        case "web":
                            ...
                            if (typeof userovoDensity !== "undefined") {
                                breakdowns.push({ label: "Densities", value: "density"});
                            }

                            if (typeof userovoBrowser !== "undefined") {
                                breakdowns.push({ label: "Browsers", value: "browser"});
                            }

                            if (typeof userovoLanguage !== "undefined") {
                                breakdowns.push({ label: "Languages", value: "langs"});
                            }

                            if (typeof userovoSources !== "undefined") {
                ...
                case "events":
                    if (event && event.length) {
                        var eventKey = event.split(userovoDashboards.factory.events.separator)[1];
                        appId = event.split(userovoDashboards.factory.events.separator)[0];

                        var allSegments = this.$store.getters["userovoDashboards/allSegments"]([appId]);
                ...
                case "user-analytics":
                    ...
                    if (userovoAuth.validateRead("active_users") && userovoGlobal.plugins && userovoGlobal.plugins.indexOf("active_users") > -1) {
                        breakdowns.push({ label: this.i18n("active_users.title"), value: "active"});
                    }
                    if (userovoAuth.validateRead("concurrent_users") && userovoGlobal.plugins && userovoGlobal.plugins.indexOf("concurrent_users") > -1) {
                ...
                case "technology":
                    ...
                    if (userovoGlobal.plugins && userovoGlobal.plugins.indexOf("density") > -1) {
                    ...
                    if (app1 && app1.type) {
                        if (app1.type === "web") {
                            if (userovoGlobal.plugins && userovoGlobal.plugins.indexOf("browser") > -1) {
            ...
            event: {
                ...
                handler: function(newVal, oldVal) {
                    ...
                    if (this.$store && event && event.length) {
                        var appId = event.split(userovoDashboards.factory.events.separator)[0];

                        this.$store.dispatch("userovoDashboards/getEvents", {appIds: [appId]});
                    }
                    if (oldVal) {
                        this.$emit("input", []);
                    }
    ...
    var EventComponent = userovoVue.views.create({
        ...
        computed: {
            ...
            allEvents: function() {
                ...
                return this.$store.getters["userovoDashboards/allEvents"](appIds);
            },
            selectedEvents: {
                get: function() {
                    if (!this.multiple) {
            ...
            appIds: {
                ...
                handler: function(newVal, oldVal) {
                    ...
                    if (this.$store && Array.isArray(appIds) && appIds.length) {
                        this.$store.dispatch("userovoDashboards/getEvents", {appIds: appIds});
                    }
    ...
    var DataTypeComponent = userovoVue.views.create({
        ...
        data: function() {
            ...
            if (userovoAuth.validateRead("core")) {
                allTypes.push(
                    {
                        value: "session",
            ...
            if (userovoAuth.validateRead("geo")) {
                allTypes.push({value: "geo", label: this.i18n("dashboards.data-type.geo")});
            }

            if (userovoAuth.validateRead("views") && userovoGlobal.plugins && (userovoGlobal.plugins.indexOf("views") > -1)) {
                allTypes.push({ label: this.i18n("dashboards.data-type.views"), value: "views"});
            }

            if (userovoAuth.validateRead("sources") && userovoGlobal.plugins && (userovoGlobal.plugins.indexOf("sources") > -1)) {
    ...
    var AppCountComponent = userovoVue.views.create({
     ...
     */
    var SourceAppsComponent = userovoVue.views.create({
    ...
    var VisualizationComponent = userovoVue.views.create({
    ...
    var TitleComponent = userovoVue.views.create({
    ...
    var PeriodComponent = userovoVue.views.create({
    ...
    var ColorsComponent = userovoVue.views.create({
        ...
        props: {
            ...
            options: {
                type: Array,
                default: function() {
                    return userovoCommon.GRAPH_COLORS;
                }
            },
    ...
    var BucketComponent = userovoVue.views.create({
        ...
        methods: {
            onChange: function(b) {
                var self = this;
                this.$store.dispatch("userovoDashboards/widgets/update", {id: this.widgetId, settings: {"bucket": b}}).then(function() {
                    self.$store.dispatch("userovoDashboards/widgets/get", self.widgetId);
                });
    ...
    var WidgetPeriodComponent = userovoVue.views.create({
        ...
        computed: {
            period: function() {
                var globalPeriod = this.$store.getters["userovoCommon/period"];
        ...
        methods: {
            formatPeriodString: function(period) {
                if (Object.prototype.hasOwnProperty.call(period, "period")) {
                    period = userovoCommon.getPeriodRange(period, Date.now());
                }
                if (Array.isArray(period)) {
                    ...
                    var periodNames = userovoCommon.convertToTimePeriodObj(period);
     ...
     */
    var PrimaryWidgetLegend = userovoVue.views.create({
     ...
     */
    var SecondaryWidgetLegend = userovoVue.views.create({
    ...
    var TitleLabelsComponent = userovoVue.views.create({
    ...
    var WidgetTitleComponent = userovoVue.views.create({
    ...
    var WidgetAppsComponent = userovoVue.views.create({
        ...
        computed: {
            ...
            app: function() {
                ...
                return {
                    id: appId,
                    name: userovoCommon.unescapeHtml(this.__getAppName(appId)),
                    image: image,
