/*global jQuery, userovoCommon, CV, userovoVue, _, UserovoHelpers, userovoGlobal */

(function(userovoDashboards) {
    ...
    userovoDashboards.service = {
        dashboards: {
            getAll: function(just_schema = false) {
                return CV.$.ajax({
                    type: "GET",
                    url: userovoCommon.API_PARTS.data.r + "/dashboards/all",
                    data: {
            ...
            get: function(dashboardId, isRefresh) {
                ...
                return CV.$.ajax({
                    type: "GET",
                    url: userovoCommon.API_PARTS.data.r + "/dashboards",
                    data: {
            ...
            create: function(settings) {
                return CV.$.ajax({
                    type: "GET",
                    url: userovoCommon.API_PARTS.data.w + "/dashboards/create",
                    data: {
                        "name": settings.name,
            ...
            update: function(dashboardId, settings) {
                return CV.$.ajax({
                    type: "GET",
                    url: userovoCommon.API_PARTS.data.w + "/dashboards/update",
                    data: {
                        "dashboard_id": dashboardId,
                        "name": settings.name,
                        "shared_email_edit": JSON.stringify(settings.shared_email_edit),
            ...
            delete: function(dashboardId) {
                return CV.$.ajax({
                    type: "GET",
                    url: userovoCommon.API_PARTS.data.w + "/dashboards/delete",
                    data: {
                        "dashboard_id": dashboardId
                    },
                    dataType: "json"
        ...
        widgets: {
            get: function(dashboardId, widgetId) {
                return CV.$.ajax({
                    type: "GET",
                    url: userovoCommon.API_PARTS.data.r + "/dashboards/widget",
                    data: {
                        "period": userovoCommon.getPeriodForAjax(),
                        "dashboard_id": dashboardId,
                        "widget_id": widgetId
            ...
            create: function(dashboardId, widget) {
                return CV.$.ajax({
                    type: "GET",
                    url: userovoCommon.API_PARTS.data.w + "/dashboards/add-widget",
                    data: {
                        "dashboard_id": dashboardId,
            ...
            update: function(dashboardId, widgetId, widget) {
                return CV.$.ajax({
                    type: "GET",
                    url: userovoCommon.API_PARTS.data.w + "/dashboards/update-widget",
                    data: {
                        "dashboard_id": dashboardId,
                        "widget_id": widgetId,
                        "widget": JSON.stringify(widget)
            ...
            delete: function(dashboardId, widgetId) {
                return CV.$.ajax({
                    type: "GET",
                    url: userovoCommon.API_PARTS.data.w + "/dashboards/remove-widget",
                    data: {
                        "dashboard_id": dashboardId,
                        "widget_id": widgetId
                    },
    ...
    userovoDashboards.getVuexModule = function() {
        var widgetsResource = userovoVue.vuex.Module("widgets", {
            state: function() {
                return {
                    all: []
                };
            ...
            actions: {
                ...
                get: function(context, widgetId) {
                    var dashboardId = context.rootGetters["userovoDashboards/selected"].id;

                    return userovoDashboards.service.widgets.get(dashboardId, widgetId).then(function(w) {
                        /*
                            Update the widget in the widget store.
                        */
                        var selectedDashbaordId = context.rootGetters["userovoDashboards/selected"].id;
                ...
                create: function(context, widget) {
                    ...
                    if (widget.settings && widget.settings.custom_period && typeof widget.settings.custom_period === "object" && widget.settings.feature !== "funnels") {
                        ...
                        widget.settings.custom_period = userovoCommon.getPeriodWithOffset(widget.settings.custom_period);
                    }
                    return userovoDashboards.service.widgets.create(dashboardId, settings).then(function(id) {
                        return id;
                    }).catch(function(e) {
                        log(e);
                        UserovoHelpers.notify({
                ...
                update: function(context, widget) {
                    ...
                    return userovoDashboards.service.widgets.update(dashboardId, widgetId, settings).then(function() {
                        return widgetId;
                    }).catch(function(e) {
                        log(e);
                        UserovoHelpers.notify({
                ...
                delete: function(context, widgetId) {
                    ...
                    return userovoDashboards.service.widgets.delete(dashboardId, widgetId).then(function() {
                        return true;
                    }).catch(function(e) {
                        log(e);
                        UserovoHelpers.notify({
                        ...
                        if (eventsObj[appId]) {
                            ...
                            if (events && events.list) {
                                for (var k = 0; k < events.list.length; k++) {
                                    ...
                                    var value = events._id + userovoDashboards.factory.events.separator + eventName;
                                    var name = userovoDashboards.factory.events.getEventLongName(eventName, events.map) + eventNamePostfix;
        ...
        var mutations = {
            ...
            setApps: function(state, apps) {
                ...
                for (var key in userovoGlobal.apps) {
                    globalApps[key] = {
                        _id: key,
                        name: userovoGlobal.apps[key].name,
                        image: userovoGlobal.apps[key].image,
                        type: userovoGlobal.apps[key].type,
                        created_at: userovoGlobal.apps[key].created_at,
                        has_image: userovoGlobal.apps[key].has_image
                    };
                }
        ...
        var actions = {
            ...
            */
            getAll: function(context, params = null) {
                ...
                return userovoDashboards.service.dashboards.getAll(just_schema).then(function(res) {
                    var dashboards = res || [];
            ...
            getDashboard: function(context, params) {
                ...
                return userovoDashboards.service.dashboards.get(dashboardId, isRefresh).then(function(res) {
                    ...
                    if (isSane) {
                        ...
                        for (var z = 0; z < widgets.length; z++) {
                            if (widgets[z].custom_period) { //modify period for displying
                                widgets[z].custom_period = userovoCommon.removePeriodOffset(widgets[z].custom_period);
                            }
                        }
            ...
            */
            ...
            create: function(context, settings) {
                return userovoDashboards.service.dashboards.create(settings).then(function(id) {
                    return id;
                }).catch(function(e) {
                    log(e);
                    UserovoHelpers.notify({
            ...
            update: function(context, settings) {
                ...
                return userovoDashboards.service.dashboards.update(dashboardId, settings).then(function() {
            ...
            delete: function(context, id) {
                return userovoDashboards.service.dashboards.delete(id).then(function() {
                ...
                for (var i = 0; i < appIds.length; i++) {
                    ...
                    if (!allEvents[appId]) {
                        allPromises.push(Promise.all(
                            [
                                userovoDashboards.service.dashboards.getEvents(appId),
                                userovoDashboards.service.dashboards.getEventGroups(appId)
                            ]
                        ));
                    }
                }
        ...
        var requestResource = userovoVue.vuex.Module("requests", {
            state: function() {
                var empty = userovoDashboards.factory.request.getEmpty();
                return empty;
            },
            getters: {
        ...
        return userovoVue.vuex.Module("userovoDashboards", {
            state: getEmptyState,
            getters: getters,
            mutations: mutations,
            actions: actions,
     ...
     */
    function log(e) {
        userovoDashboards.factory.log(e);
    }
...
})(window.userovoDashboards = window.userovoDashboards || {});
