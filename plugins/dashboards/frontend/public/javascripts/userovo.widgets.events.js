/*global userovoVue, CV, userovoCommon, userovoGraphNotesCommon */
    ...
    var WidgetComponent = userovoVue.views.create({
        ...
        computed: {
            ...
            timelineGraph: function() {
                ...
                for (var app in this.data.dashData.data) {
                    ...
                    for (var myevent in this.data.dashData.data[app]) {
                        ...
                        for (var k = 0; k < this.data.metrics.length; k++) {
                            ...
                            series.push({ "data": [], "name": name, "app": app, "metric": this.data.metrics[k], "event": eventName, color: userovoCommon.GRAPH_COLORS[series.length]});
                        }
                ...
                else if (userovoCommon.periodObj.daysInPeriod === 1 && userovoCommon.periodObj.isSpecialPeriod === true) {
