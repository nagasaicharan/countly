/*global userovoVue, CV, userovoCommon, ElementTiptap */
...
(function() {
    var WidgetComponent = userovoVue.views.create({
        ...
        computed: {
            widgetHTML: function() {
                var unescapedHTML = userovoCommon.unescapeHtml(this.data.contenthtml);
    ...
    var DrawerComponent = userovoVue.views.create({
        ...
        computed: {
            contentHtml: {
                get() {
                    this.scope.editedObject.contenthtml = userovoCommon.unescapeHtml(this.scope.editedObject.contenthtml);
