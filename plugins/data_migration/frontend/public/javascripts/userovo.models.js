/*global userovoCommon, UserovoHelpers, jQuery*/
(function(userovoDataMigration, $) {
     ...
     */
    userovoDataMigration.initialize = function() {
        return $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/o/datamigration/get_config",
            data: {
     ...
     */
    userovoDataMigration.loadExportList = function() {
        return $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/o/datamigration/getmyexports",
            data: {
                "app_id": userovoCommon.ACTIVE_APP_ID,
            },
            success: function(json) {
                if (json.result && Array.isArray(json.result)) {
                    for (var i = 0; i < json.result.length; i++) {
                        ...
                        json.result[i].appnames = UserovoHelpers.appIdsToNames(json.result[i].apps);
    ...
    userovoDataMigration.loadImportList = function() {
        return $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/o/datamigration/getmyimports",
            data: {
                "app_id": userovoCommon.ACTIVE_APP_ID,
            },
            success: function(json) {
    ...
    userovoDataMigration.stopExport = function(exportid, callback) {
        $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/i/datamigration/stop_export",
            data: {
                "app_id": userovoCommon.ACTIVE_APP_ID,
                "exportid": exportid
            },
    ...
    userovoDataMigration.deleteExport = function(exportid, callback) {
        $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/i/datamigration/delete_export",
            data: {
                "app_id": userovoCommon.ACTIVE_APP_ID,
                "exportid": exportid
            },
    ...
    userovoDataMigration.deleteImport = function(exportid, callback) {
        $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/i/datamigration/delete_import",
            data: {
                "app_id": userovoCommon.ACTIVE_APP_ID,
                "exportid": exportid
            },
    ...
    userovoDataMigration.saveImport = function(importData, callback) {
        $.ajax({
            type: "POST",
            url: userovoCommon.API_URL + "/i/datamigration/import",
    ...
    userovoDataMigration.saveExport = function(exportData, callback) {
        $.ajax({
            type: "POST",
            url: userovoCommon.API_URL + "/i/datamigration/export",
    ...
    userovoDataMigration.createToken = function(callback) {
        $.ajax({
            type: "POST",
            url: userovoCommon.API_URL + "/o/datamigration/createimporttoken",
            data: {
                "app_id": userovoCommon.ACTIVE_APP_ID,
            },
            success: function(json) {
    ...
    userovoDataMigration.testConnection = function(token, address, callback) {
        $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/o/datamigration/validateconnection",
            data: {
                "app_id": userovoCommon.ACTIVE_APP_ID,
                "server_token": token,
    ...
    userovoDataMigration.sendExport = function(exportid, token, address, rediret_traffic, callback) {
        $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/i/datamigration/sendexport",
            data: {
                "app_id": userovoCommon.ACTIVE_APP_ID,
                "server_token": token,
                "server_address": address,
    ...
    userovoDataMigration.getData = function() {
        return _data;
    };

    userovoDataMigration.getExportList = function() {
        return _export_list;
    };

    userovoDataMigration.getImportList = function() {
        return _import_list;
    };

}(window.userovoDataMigration = window.userovoDataMigration || {}, jQuery));