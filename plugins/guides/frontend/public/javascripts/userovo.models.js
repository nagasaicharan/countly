/* global userovoCMS CV userovoGlobal */

(function(userovoGuides) {
    ...
    userovoGuides.memberViewedGuides = function(user_id) {
        CV.$.ajax({
            type: "POST",
            url: "/guides/viewed",
            dataType: "json",
    ...
    userovoGuides.fetchEntries = function(query, refresh) {
        return new Promise(function(resolve, reject) {
            userovoCMS.fetchEntry(API_key, {populate: true, query, refresh})
                .then(function(data) {
    ...
    userovoGuides.getEntries = function() {
        return _entries;
    };

    userovoGuides.getEntry = function(sectionID) {
        return _entries.find(function(entry) {
            return entry.sectionID === sectionID;
        });
    };

    userovoGuides.getWalkthroughs = function(sectionID) {
    ...
    userovoGuides.getArticles = function(sectionID) {
        let entries = _entries;
        if (sectionID) {
            entries = _entries.filter(function(entry) {
                return entry.sectionID === sectionID;
    ...
    userovoGuides.searchEntries = function(searchKey) {
        return new Promise(function(resolve, reject) {
            ...
            userovoGuides.fetchEntries(query)
...
}(window.userovoGuides = window.userovoGuides || {}));