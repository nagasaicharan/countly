/* global userovoVue,CV,userovoCommon,userovoLanguage*/
(function() {
    var FEATURE_NAME = 'locale';
    var LanguageView = userovoVue.views.create({
        ...
        mounted: function() {
            this.$store.dispatch('userovoLanguage/fetchAll', true);
        },
        methods: {
            refresh: function(force) {
                this.$store.dispatch('userovoLanguage/fetchAll', force);
            },
        ...
        computed: {
            data: function() {
                return this.$store.state.userovoLanguage.Language;
            },
                    ...
                    series: [
                        {
                            ...
                            label: {
                                formatter: "{a|" + CV.i18n('common.table.new-users') + "}\n" + userovoCommon.getShortNumber(self.data.totals.newUsers || 0),
                                fontWeight: 500,
                                fontSize: 16,
                                fontFamily: "Inter",
                                lineHeight: 24,
                    ...
                    series: [
                        {
                            ...
                            label: {
                                formatter: "{a|" + CV.i18n('common.table.total-sessions') + "}\n" + userovoCommon.getShortNumber(self.data.totals.totalSessions || 0),
                                fontWeight: 500,
                                fontSize: 16,
                                fontFamily: "Inter",
                                lineHeight: 24,
            ...
            isLoading: function() {
                return this.$store.getters["userovoLanguage/isLoading"];
            },
    ...
    userovoVue.container.registerTab("/analytics/geo", {
        priority: 10,
        name: "languages",
