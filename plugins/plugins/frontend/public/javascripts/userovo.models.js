/*global userovoCommon,jQuery,userovoGlobal,CV */
(function(userovoPlugins, $) {
    ...
    //Public Methods
    userovoPlugins.initialize = function() {
        return $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/o/plugins",
            data: {
    ...
    userovoPlugins.getTitle = function(code) {
    ...
    userovoPlugins.getRelativePlugins = function(code, direction) {
    ...
    userovoPlugins.toggle = function(plugins, callback) {
        $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/i/plugins",
            data: {
    ...
    userovoPlugins.initializeConfigs = function() {
        return $.when(
            $.ajax({
                type: "GET",
                url: userovoCommon.API_URL + "/o/themes",
                data: {
                    app_id: userovoCommon.ACTIVE_APP_ID
                },
                success: function(json) {
            ...
            $.ajax({
                type: "GET",
                url: userovoCommon.API_URL + "/o/configs",
                data: {
                    app_id: userovoCommon.ACTIVE_APP_ID
                },
                success: function(json) {
    ...
    userovoPlugins.updateConfigs = function(configs, callback) {
        $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/i/configs",
            data: {
    ...
    userovoPlugins.initializeUserConfigs = function() {
        return $.when(
            $.ajax({
                type: "GET",
                url: userovoCommon.API_URL + "/o/themes",
            ...
            $.ajax({
                type: "GET",
                url: userovoCommon.API_URL + "/o/userconfigs",
                data: {
                    app_id: userovoCommon.ACTIVE_APP_ID
                },
                success: function(json) {
    ...
    userovoPlugins.initializeActiveAppConfigs = function() {
        return $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/o/apps/plugins",
            data: {
                app_id: userovoCommon.ACTIVE_APP_ID,
            },
            success: function(appPluginsConfig) {
                userovoGlobal.apps[userovoCommon.ACTIVE_APP_ID].plugins = appPluginsConfig.plugins;
            }
        });
    };

    userovoPlugins.updateUserConfigs = function(configs, callback) {
        $.ajax({
            type: "GET",
            url: userovoCommon.API_URL + "/i/userconfigs",
            data: {
                configs: JSON.stringify(configs),
                app_id: userovoCommon.ACTIVE_APP_ID
            },
    ...
    userovoPlugins.getData = function() {
        return _pluginsData;
    };

    userovoPlugins.getConfigsData = function() {
        return _configsData;
    };

    userovoPlugins.getUserConfigsData = function() {
        return _userConfigsData;
    };

    userovoPlugins.getThemeList = function() {
        var themeList = [];
    ...
    userovoPlugins.deleteAccount = function(configs, callback) {
        $.ajax({
            type: "POST",
            url: userovoCommon.API_URL + "/i/users/deleteOwnAccount",
            data: {
    ...
    userovoPlugins.getConfigWarnings = function(configGroup, key) {
        var warnings = initializeConfigWarnings();
        var mapKey = configGroup + "." + key;
        return warnings[mapKey] || [];
    };

    userovoPlugins.getTooltipColors = function() {
        return TOOLTIP_COLORS;
    };

    userovoPlugins.getTooltipLabel = function(type) {
        var labels = {
...
}(window.userovoPlugins = window.userovoPlugins || {}, jQuery));
