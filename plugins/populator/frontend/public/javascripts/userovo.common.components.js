/*global userovoVue, Vue, CV, UserovoHelpers */

(function() {
    Vue.component("cly-populator-left-container", userovoVue.components.BaseComponent.extend({
    ...
    Vue.component("cly-populator-number-selector", userovoVue.components.BaseComponent.extend({
        mixins: [userovoVue.mixins.i18n],
        props: {
            value: {
                type: Number,
    ...
    Vue.component("cly-populator-condition-selector", userovoVue.components.BaseComponent.extend({
        mixins: [userovoVue.mixins.i18n],
        props: {
            value: {
                type: [Object, Array],
    ...
    Vue.component("cly-populator-section-detail", userovoVue.components.BaseComponent.extend({
        mixins: [userovoVue.mixins.i18n],
        props: {
            title: {
                type: String,
    ...
    const userSection = userovoVue.views.create({
        mixins: [userovoVue.mixins.i18n],
        props: {
            value: {
                type: [Object, Array],
    ...
    const eventsSection = userovoVue.views.create({
        mixins: [userovoVue.mixins.i18n],
        props: {
            isOpen: {
                type: Boolean,
    ...
    const viewsSection = userovoVue.views.create({
        mixins: [userovoVue.mixins.i18n],
        props: {
            isOpen: {
                type: Boolean,
    ...
    const sequencesSection = userovoVue.views.create({
        mixins: [userovoVue.mixins.i18n],
        props: {
            isOpen: {
                type: Boolean,
    ...
    const behaviorSection = userovoVue.views.create({
        mixins: [userovoVue.mixins.i18n],
        props: {
            isOpen: {
                type: Boolean,
    ...
    Vue.component("cly-populator-section", userovoVue.components.BaseComponent.extend({
        props: {
            type: {
                type: String,
                default: '',
