...
/*global userovoVue,CV,userovoCommon,userovoSegmentation,moment,_,userovoGlobalLang,userovoEventsOverview,userovoPushNotificationApprover,userovoGlobal,UserovoHelpers*/
(function(userovoPushNotification) {
    ...
    userovoPushNotification.helper = {
        ...
        getInitialBaseModel: function() {
            return {
                isEe: typeof userovoSegmentation !== 'undefined',
                isGeo: typeof userovoLocationTargetComponent !== 'undefined',
                isCohorts: typeof userovoCohorts !== 'undefined',
                _id: null,
                demo: false,
                saveStats: false,
                name: "",
        ...
        getInitialAutomaticModel: function() {
            ...
            baseModel.automatic = {
                ...
                trigger: typeof userovoCohorts === 'undefined' ? TriggerEnum.EVENT : TriggerEnum.COHORT_ENTRY,
    ...
    var pushTableResource = userovoVue.vuex.ServerDataTable("pushTable", {
        columns: ['name', 'status', 'sent', 'actioned', 'createdDateTime', 'lastDate'],
        onRequest: function(context) {
            context.rootState.userovoPushNotificationMain.isLoadingTable = true;
            var data = {
                app_id: userovoCommon.ACTIVE_APP_ID,
                visibleColumns: JSON.stringify(context.state.params.selectedDynamicCols),
            };
            var type = context.rootState.userovoPushNotificationMain.selectedPushNotificationType;
            var status = context.rootState.userovoPushNotificationMain.statusFilter;
            var params = userovoPushNotification.service.getFetchAllParameters(type, status);
            for (var key in params) {
                data[key] = params[key];
            }
            return {
                type: "GET",
                url: userovoCommon.API_PARTS.data.r + "/push/message/all",
                data: data
            };
        },
        onReady: function(context, rows) {
            rows = userovoPushNotification.mapper.incoming.mapRows({"aaData": rows});
            context.rootState.userovoPushNotificationMain.isLoadingTable = false;
            return rows;
        },
    ...
    //NOTE: api object will reside temporarily in userovoPushNotification until userovoApi object is created;
    userovoPushNotification.api = {
        findById: function(id) {
            ...
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    type: "GET",
                    url: window.userovoCommon.API_URL + "/o/push/message/GET",
                    data: data,
                    ...
                    error: function(error) {
                        console.error(error);
                        var errorMessage = userovoPushNotification.helper.getErrorMessage(error);
        ...
        getDashboard: function(echo) {
            ...
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    type: "GET",
                    url: window.userovoCommon.API_URL + '/o/push/dashboard',
                    data: data,
                    dataType: "json",
                    success: function(response) {
                        resolve(response);
        ...
        delete: function(data) {
            ...
            return new Promise(function(resolve, reject) {
                return CV.$.ajax({
                    method: 'GET',
                    url: window.userovoCommon.API_URL + '/i/push/message/remove',
                    data: data,
                    dataType: "json",
                    success: function(response) {
                        resolve(response);
        ...
        save: function(dto) {
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    type: "POST",
                    url: window.userovoCommon.API_URL + '/i/push/message/create?app_id=' + userovoCommon.ACTIVE_APP_ID,
        ...
        sendToTestUsers: function(dto) {
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    type: "POST",
                    url: window.userovoCommon.API_URL + '/i/push/message/test?app_id=' + userovoCommon.ACTIVE_APP_ID,
                    data: JSON.stringify(dto),
                    contentType: "application/json",
                    success: function(response) {
                        resolve(response);
        ...
        update: function(dto) {
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    type: "POST",
                    url: window.userovoCommon.API_URL + '/i/push/message/update?app_id=' + userovoCommon.ACTIVE_APP_ID,
                    data: JSON.stringify(dto),
                    contentType: "application/json",
                    success: function(response) {
                        if (response.error) {
        ...
        estimate: function(data) {
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    type: "POST",
                    url: window.userovoCommon.API_URL + '/o/push/message/estimate?app_id=' + userovoCommon.ACTIVE_APP_ID,
        ...
        getMime: function(url) {
            ...
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    method: 'GET',
                    url: window.userovoCommon.API_URL + '/o/push/mime',
                    data: data,
                    success: function(response) {
                        resolve(response);
                    },
        ...
        findAllUserProperties: function() {
            if (typeof userovoSegmentation === 'undefined') {
                return Promise.resolve({});
            }
            return userovoSegmentation.initialize("").then(function() {
                return Promise.resolve(userovoSegmentation.getFilters());
            });
        },
        searchUsers: function(query, options) {
            ...
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    type: "POST",
                    url: userovoCommon.API_PARTS.data.r + "?app_id=" + options.appId + "&method=user_details",
                    contentType: "application/json",
                    data: JSON.stringify(data),
                    success: function(response) {
                        resolve(response);
        ...
        updateAppConfig: function(config, options) {
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    type: "POST",
                    url: userovoCommon.API_PARTS.apps.w + '/update/plugins?app_id=' + options.app_id,
                    data: {
        ...
        toggle: function(id, isActive) {
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    type: "GET",
                    url: window.userovoCommon.API_URL + '/i/push/message/toggle',
                    data: {
                        _id: id,
                        active: isActive,
                        app_id: userovoCommon.ACTIVE_APP_ID
    ...
    userovoPushNotification.mapper = {
        incoming: {
            addLabelToUserPropertiesDto: function(userPropertiesDto, userProperties) {
                ...
                Object.keys(userPropertiesDto).forEach(function(key) {
                    if (userPropertiesDto[key].t === UserPropertyTypeEnum.API) {
                        ...
                        userPropertiesDto[key].l = userovoPushNotification.helper.findUserPropertyLabelByValue(userPropertiesDto[key].k, userProperties);
                    }
                });
            },
            ...
            mapErrors: function(dto) {
                ...
                return Object.keys(dto.result.errors).map(function(errorKey) {
                    ...
                    if (userovoPushNotification.helper.isInternationalizationFound('push-notification.error-code.' + errorKey + '.desc')) {
                        result.description = CV.i18n('push-notification.error-code.' + errorKey + '.desc');
                        return result;
                    }
                    if (userovoPushNotification.helper.isInternationalizationFound('push-notification.error-code.' + platformError + numberError + '.desc')) {
            ...
            mapAndroidSettings: function(androidSettingsDto) {
                return {
                    ...
                    onClickURL: androidSettingsDto && androidSettingsDto.url ? userovoCommon.decodeHtml(androidSettingsDto.url) : '',
                    mediaURL: androidSettingsDto && androidSettingsDto.media ? userovoCommon.decodeHtml(androidSettingsDto.media) : '',
            ...
            mapIOSSettings: function(iosSettingsDto) {
                ...
                if (iosSettingsDto && Array.isArray(iosSettingsDto.specific)) {
                    ...
                    if (subtitleItem) {
                        subtitle = userovoPushNotification.helper.decodeMessage(subtitleItem.subtitle || "");
                    }
                ...
                return {
                    ...
                    onClickURL: iosSettingsDto && iosSettingsDto.url ? userovoCommon.decodeHtml(iosSettingsDto.url) : '',
                    mediaURL: iosSettingsDto && iosSettingsDto.media ? userovoCommon.decodeHtml(iosSettingsDto.media) : '',
            ...
            mapSettings: function(dto) {
                ...
                result[PlatformEnum.ALL] = {};
                result[PlatformEnum.ALL].mediaURL = defaultLocale.media ? userovoCommon.decodeHtml(defaultLocale.media) : "";
            ...
            mapMessageLocalizationButtons: function(buttonsDto) {
                ...
                buttonsDto.map(function(buttonDtoItem) {
                    buttons.push({label: buttonDtoItem.title, url: buttonDtoItem.url ? userovoCommon.decodeHtml(buttonDtoItem.url) : buttonDtoItem.url});
                });
                return buttons;
            },
            ...
            mapAllDashboardLocales: function(locales, dto, platformDto, platform) {
                ...
                Object.keys(dto.result.subs[platformDto].subs).forEach(function(key) {
                    if (!allLocales[platform]) {
                        allLocales[key] = userovoPushNotification.helper.getInitialModelDashboardPlatform();
                    }
            ...
            mapDtoToBaseModel: function(dto) {
                ...
                return {
                    ...
                    expiration: userovoPushNotification.helper.convertMSToDaysAndHours(this.findDefaultLocaleItem(dto.contents).expiration),
            ...
            mapDtoToAutomaticModel: function(dto) {
                ...
                if (triggerDto.time) {
                    var result = userovoPushNotification.helper.convertMSToDaysAndHours(triggerDto.time);
                    model.automatic.usersTimezone = new Date();
                    model.automatic.usersTimezone.setHours(result.hours, result.minutes);
                }
                model.automatic.delayed = userovoPushNotification.helper.convertMSToDaysAndHours(triggerDto.delay);
                model.automatic.maximumMessagesPerUser = triggerDto.cap || 1,
                model.automatic.minimumTimeBetweenMessages = userovoPushNotification.helper.convertMSToDaysAndHours(triggerDto.sleep);
                return model;
            },
            ...
            mapLocalizationByKey: function(localizationKey) {
                var label = userovoGlobalLang.languages[localizationKey] && userovoGlobalLang.languages[localizationKey].englishName;
            ...
            hasAnyLocales: function(localesDto) {
                if (localesDto) {
                    return Object.keys(localesDto).some(function(localeKey) {
                        return Boolean(userovoGlobalLang.languages[localeKey]);
                    });
                }
                return false;
            },
            mapLocalizations: function(localesDto) {
                ...
                if (!this.hasAnyLocales(localesDto)) {
                    return [userovoPushNotification.helper.getDefaultLocalization()];
                }
                var result = Object.keys(localesDto).reduce(function(allLocales, localeKey) {
                    if (localeKey !== DEFAULT_LOCALIZATION_VALUE && localeKey !== 'count') {
                        ...
                        if (localesDto.count && localesDto.count !== 0) {
                            localizationItem.percentage = UserovoHelpers.formatPercentage(localesDto[localeKey] / localesDto.count);
                        }
                        else {
                ...
                result.unshift(userovoPushNotification.helper.getDefaultLocalization());
                return result;
            },
        ...
        outgoing: {
            ...
            mapButtons: function(localizedMessage) {
                ...
                localizedMessage.buttons.forEach(function(localizedButton) {
                    ...
                    if (localizedButton.url) {
                        buttonDto.url = userovoCommon.decodeHtml(localizedButton.url);
                    }
            ...
            mapIOSSettings: function(model, options) {
                ...
                if (iosSettings.json && options.settings[PlatformEnum.IOS].isJsonEnabled) {
                    result.data = userovoPushNotification.helper.prettifyJSON(iosSettings.json, 0);
                }
                ...
                if (iosSettings.onClickURL && options.settings[PlatformEnum.IOS].isOnClickURLEnabled && model.messageType === MessageTypeEnum.CONTENT) {
                    result.url = userovoCommon.decodeHtml(iosSettings.onClickURL);
                }
                ...
                if (model.settings[PlatformEnum.IOS].mediaURL && options.settings[PlatformEnum.IOS].isMediaURLEnabled && model.messageType === MessageTypeEnum.CONTENT) {
                    result.media = userovoCommon.decodeHtml(model.settings[PlatformEnum.IOS].mediaURL);
            ...
            mapAndroidSettings: function(model, options) {
                ...
                if (androidSettings.json && options.settings[PlatformEnum.ANDROID].isJsonEnabled) {
                    result.data = userovoPushNotification.helper.prettifyJSON(androidSettings.json, 0);
                }
                ...
                if (androidSettings.onClickURL && options.settings[PlatformEnum.ANDROID].isOnClickURLEnabled && model.messageType === MessageTypeEnum.CONTENT) {
                    result.url = userovoCommon.decodeHtml(androidSettings.onClickURL);
                }
                ...
                if (model.settings[PlatformEnum.ANDROID].mediaURL && options.settings[PlatformEnum.ANDROID].isMediaURLEnabled && model.messageType === MessageTypeEnum.CONTENT) {
                    result.media = userovoCommon.decodeHtml(model.settings[PlatformEnum.ANDROID].mediaURL);
            ...
            mapAutomaticTrigger: function(model, options) {
                ...
                if (options.isUsersTimezoneSet) {
                    ...
                    result.time = userovoPushNotification.helper.convertDateTimeToMS(usersTimezone);
                }
                if (model.automatic.deliveryMethod === DeliveryMethodEnum.DELAYED) {
                    ...
                    result.delay = userovoPushNotification.helper.convertDateTimeToMS(deliveryDateTime);
                }
                if (model.automatic.capping) {
                    ...
                    result.sleep = userovoPushNotification.helper.convertDateTimeToMS(cappingDateTime);
                }
            ...
            mapFilters: function(model, options) {
                ...
                if (options.queryFilter && options.from === 'drill') {
                    ...
                    var period = userovoCommon.getPeriod();
            ...
            mapModelToBaseDto: function(pushNotificationModel, options) {
                var resultDto = {
                    app: userovoCommon.ACTIVE_APP_ID,
                ...
                if (pushNotificationModel.settings[PlatformEnum.ALL].mediaURL && pushNotificationModel.messageType === MessageTypeEnum.CONTENT) {
                    var defaultLocale = userovoPushNotification.mapper.incoming.findDefaultLocaleItem(contentsDto);
                    defaultLocale.media = userovoCommon.decodeHtml(pushNotificationModel.settings[PlatformEnum.ALL].mediaURL);
                ...
                var expirationInMS = userovoPushNotification.helper.convertDateTimeToMS({
    ...
    userovoPushNotification.service = {
        ...
        isPushNotificationApproverPluginEnabled: function() {
            return Boolean(window.userovoPushNotificationApprover);
        },
        isUserProfilesPluginEnabled: function() {
            return Boolean(window.userovoUsers);
        },
        isDrillPluginEnabled: function() {
            return Boolean(window.userovoDrill);
        },
        hasApproverBypassPermission: function() {
            return this.isPushNotificationApproverPluginEnabled && userovoGlobal.member.approver_bypass;
        },
        hasApproverPermission: function() {
            return this.isPushNotificationApproverPluginEnabled && userovoGlobal.member.approver;
        },
        ...
        fetchCohorts: function(cohortIdsList, shouldFetchIfEmpty, appId) {
            ...
            if (typeof userovoCohorts === 'undefined') {
                return Promise.resolve([]);
            }
            return new Promise(function(resolve, reject) {
                CV.$.ajax({
                    ...
                    data: {
                        app_id: appId || userovoCommon.ACTIVE_APP_ID,
                        method: "get_cohorts",
                        outputFormat: "full"
                    },
                    dataType: "json",
        ...
        fetchLocations: function(locationIdsList, shouldFetchIfEmpty) {
            ...
            if (typeof userovoLocationTargetComponent === 'undefined') {
                return Promise.resolve([]);
            }
            return new Promise(function(resolve, reject) {
                ...
                CV.$.ajax({
                    ...
                    success: function(response) {
                        try {
                            var targetLocations = userovoPushNotification.mapper.incoming.mapLocationTarget(response);
        ...
        fetchEvents: function() {
            return new Promise(function(resolve, reject) {
                userovoEventsOverview.service.fetchAllEvents()
                    .then(function(events) {
                        try {
                            resolve(userovoPushNotification.mapper.incoming.mapEvents(events.list || []));
                        }
                        catch (error) {
                            console.error(error);
                            reject(new Error(CV.i18n('push-notification.unknown-error')));
        ...
        fetchAll: function(type, status) {
            var self = this;
            return new Promise(function(resolve, reject) {
                userovoPushNotification.api.findAll(self.getFetchAllParameters(type, status))
                    .then(function(response) {
                        try {
                            resolve(userovoPushNotification.mapper.incoming.mapRows(response));
                        }
                        catch (error) {
                            console.error(error);
                            reject(new Error(CV.i18n('push-notification.unknown-error')));
        ...
        fetchById: function(id) {
            ...
            return new Promise(function(resolve, reject) {
                self.fetchUserProperties().then(function(userProperties) {
                    userovoPushNotification.api.findById(id).then(function(response) {
                        response.userProperties = userProperties;
                        var model = null;
                        try {
                            model = userovoPushNotification.mapper.incoming.mapDtoToModel(response);
                            resolve(model);
                        }
                        catch (error) {
                            console.error(error);
        ...
        fetchDashboard: function(echo) {
            return new Promise(function(resolve, reject) {
                userovoPushNotification.api.getDashboard(echo)
                    .then(function(response) {
                        try {
                            resolve(userovoPushNotification.mapper.incoming.mapMainDashboard(response));
                        }
                        catch (error) {
                            console.error(error);
                            reject(new Error(CV.i18n('push-notification.unknown-error')));
        ...
        fetchMediaMetadata: function(url) {
            return new Promise(function(resolve, reject) {
                userovoPushNotification.api.getMime(url).then(function(response) {
                    try {
                        resolve(userovoPushNotification.mapper.incoming.mapMediaMetadata(response));
                    }
                    catch (error) {
                        console.error(error);
                        reject(new Error(CV.i18n('push-notification.unknown-error')));
        ...
        fetchUserProperties: function() {
            return userovoPushNotification.api.findAllUserProperties().catch(function(error) {
                console.error(error);
                return Promise.resolve([]);
            });
        },
        fetchTestUsers: function(testUsers, options) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                Promise.all([usersQuery ? userovoPushNotification.api.searchUsers(usersQuery, options) : Promise.resolve([]), self.fetchCohorts(testUsers.cohorts || [], false)])
        ...
        searchUsersById: function(idQuery, options) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                userovoPushNotification.api.searchUsers(drillQuery, options)
                    .then(function(response) {
        ...
        estimate: function(pushNotificationModel, options) {
            ...
            try {
                var platformsDto = userovoPushNotification.mapper.outgoing.mapPlatforms(pushNotificationModel.platforms);
                data.platforms = platformsDto;
                var filtersDto = userovoPushNotification.mapper.outgoing.mapFilters(pushNotificationModel, options);
                if (userovoPushNotification.helper.shouldAddFilter(pushNotificationModel, options) && filtersDto) {
            ...
            return new Promise(function(resolve, reject) {
                userovoPushNotification.api.estimate(data).then(function(response) {
                    try {
                        var localesDto = response.locales;
                        localesDto.count = response.count;
                        var localizations = userovoPushNotification.mapper.incoming.mapLocalizations(localesDto);
        ...
        delete: function(id) {
            ...
            return userovoPushNotification.api.delete(data);
        },
        save: function(model, options) {
            var dto = null;
            try {
                dto = userovoPushNotification.mapper.outgoing.mapModelToDto(model, options);
            }
            catch (error) {
                console.error(error);
                return Promise.reject(new Error(CV.i18n('push-notification.unknown-error')));
            }
            return userovoPushNotification.api.save(dto);
        },
        update: function(model, options) {
            ...
            return userovoPushNotification.api.update(dto);
        },
        sendToTestUsers: function(model, options) {
            ...
            return new Promise(function(resolve, reject) {
                userovoPushNotification.api.sendToTestUsers(dto)
        ...
        approve: function(messageId) {
            ...
            return new Promise(function(resolve, reject) {
                userovoPushNotificationApprover.service.approve(messageId)
                    .then(function(response) {
                        resolve(response);
                    })
                    .catch(function(error) {
        ...
        reject: function(messageId) {
            ...
            return new Promise(function(resolve, reject) {
                userovoPushNotificationApprover.service.reject(messageId)
                    .then(function(response) {
                        resolve(response);
                    })
                    .catch(function(error) {
        ...
        updateTestUsers: function(testUsersModel, options) {
            ...
            try {
                var testDto = userovoPushNotification.mapper.outgoing.mapTestUsersEditedModelToDto(testUsersModel);
            ...
            return userovoPushNotification.api.updateAppConfig(appConfig, options);
        },
        toggle: function(id, isActive) {
            return userovoPushNotification.api.toggle(id, isActive);
        }
    };
    ...
    var getDetailsInitialState = function() {
        ...
        return {
            pushNotification: userovoPushNotification.helper.getInitialModel(TypeEnum.ONE_TIME),
            platformFilter: null,
            platformFilterOptions: [],
            localeFilter: null,
            messageLocaleFilter: userovoPushNotification.service.DEFAULT_LOCALIZATION_VALUE,
            userCommand: {
                type: null,
    ...
    var detailsActions = {
        fetchById: function(context, id) {
            ...
            userovoPushNotification.service.fetchById(id)
                .then(function(model) {
        ...
        onApprove: function(context, id) {
            ...
            userovoPushNotification.service.approve(id).then(function() {
                context.dispatch('onFetchSuccess', {useLoader: false});
                context.dispatch('fetchById', id);
                UserovoHelpers.notify({message: CV.i18n('push-notification.was-successfully-approved')});
            }).catch(function(error) {
                console.error(error);
        ...
        onReject: function(context, id) {
            context.dispatch('onFetchInit', {useLoader: false});
            userovoPushNotification.service.reject(id).then(function() {
                context.dispatch('onFetchSuccess', {useLoader: false});
                context.dispatch('fetchById', id);
                UserovoHelpers.notify({message: CV.i18n('push-notification.was-successfully-rejected')});
            }).catch(function(error) {
                console.error(error);
                context.dispatch('onFetchError', {error: error, useLoader: false});
                UserovoHelpers.notify({message: error.message, type: "error"});
        ...
        onDelete: function(context, id) {
            return new Promise(function(resolve, reject) {
                context.dispatch('onFetchInit', {useLoader: true});
                userovoPushNotification.service.delete(id)
                    .then(function() {
                        context.dispatch('onFetchSuccess', {useLoader: true});
                        UserovoHelpers.notify({message: CV.i18n('push-notification.was-successfully-deleted')});
                        resolve();
                    }).catch(function(error) {
                        console.error(error);
                        context.dispatch('onFetchError', {error: error, useLoader: true});
        ...
        onToggle: function(context, payload) {
            context.dispatch('onFetchInit', {useLoader: false});
            userovoPushNotification.service.toggle(payload.id, payload.isActive).then(function() {
                context.dispatch('onFetchSuccess', {useLoader: false});
                context.dispatch('fetchById', payload.id);
                UserovoHelpers.notify({message: CV.i18n(payload.isActive ? 'push-notification.was-successfully-started' : 'push-notification.was-successfully-stopped')});
            }).catch(function(error) {
                console.error(error);
                context.dispatch('onFetchError', {error: error, useLoader: false});
                UserovoHelpers.notify({message: error.message, type: "error"});
    ...
    var detailsMutations = {
        ...
        setPlatformFilterOptions: function(state, value) {
            ...
            if (value.dashboard[PlatformEnum.IOS]) {
                filterOptions.push({label: CV.i18n("push-notification.platform-filter-ios"), value: userovoPushNotification.service.PlatformEnum.IOS});
                state.platformFilter = PlatformEnum.IOS;
            }
            if (value.dashboard[PlatformEnum.ANDROID]) {
                filterOptions.push({label: CV.i18n("push-notification.platform-filter-android"), value: userovoPushNotification.service.PlatformEnum.ANDROID});
                state.platformFilter = PlatformEnum.ANDROID;
            }
            if (value.dashboard[PlatformEnum.ALL]) {
                filterOptions.push({label: CV.i18n("push-notification.platform-filter-all"), value: userovoPushNotification.service.PlatformEnum.ALL});
    ...
    userovoPushNotification.details = {};
    userovoPushNotification.details.getVuexModule = function() {
        return userovoVue.vuex.Module("userovoPushNotificationDetails", {
    ...
    var getMainInitialState = function() {
        return {
            rows: [],
            selectedPushNotificationType: userovoPushNotification.service.TypeEnum.ONE_TIME,
            statusFilter: ALL_FILTER_OPTION_VALUE,
            platformFilter: userovoPushNotification.service.PlatformEnum.ALL,
    ...
    userovoPushNotification.main = {};
    userovoPushNotification.main.getVuexModule = function() {
        var getters = {
            isLoadingTable: function(state) {
                return state.isLoadingTable;
            },
        };
        return userovoVue.vuex.Module("userovoPushNotificationMain", {
            state: getMainInitialState,
            actions: mainActions,
            mutations: mainMutations,
            getters: getters,
            submodules: [userovoVue.vuex.FetchMixin(), pushTableResource]
        });
    };
    ...
    var dashboardActions = {
        fetchDashboard: function(context, shouldRefresh) {
            ...
            if (context.state.userovoFetch.isLoading) {
                return;
            }
            context.dispatch('onFetchInit', {useLoader: true});
    ...
    userovoPushNotification.dashboard = {};
    userovoPushNotification.dashboard.getVuexModule = function() {
        return userovoVue.vuex.Module("userovoPushNotificationDashboard", {
...
}(window.userovoPushNotification = window.userovoPushNotification || {}));