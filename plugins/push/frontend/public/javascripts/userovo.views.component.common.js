...
/*global CV,userovoVue,userovoPushNotification,userovoGlobal,userovoCommon,moment*/
(function(userovoPushNotificationComponent) {
    userovoPushNotificationComponent.LargeRadioButtonWithDescription = userovoVue.views.create({
        props: {
            value: {
                type: [String, Boolean],
                required: true
    ...
    userovoPushNotificationComponent.LineRadioButtonWithDescription = userovoVue.views.create({
        props: {
            value: {
                type: String,
                required: true
    ...
    userovoPushNotificationComponent.MessageSettingElement = userovoVue.views.create({
        props: {
            input: {
                type: String,
                default: "",
    ...
    userovoPushNotificationComponent.ReviewSectionRow = userovoVue.views.create({
        props: {
            value: {
                type: [String, Number],
                default: ""
    ...
    userovoPushNotificationComponent.AddUserPropertyPopover = userovoVue.views.create({
        props: {
            userProperty: {
                type: Object,
                default: function() {
                    return {
                        ...
                        fallback: "",
                        isUppercase: false,
                        type: userovoPushNotification.service.UserPropertyTypeEnum.USER
                    };
                }
            },
            isOpen: {
    ...
    userovoPushNotificationComponent.UserPropertyTextPreview = userovoVue.views.create({
    ...
    userovoPushNotificationComponent.UserPropertyPreview = userovoVue.views.create({
    ...
    userovoPushNotificationComponent.MobileMessagePreview = userovoVue.views.create({
        ...
        data: function() {
            return {
                ...
                appName: userovoGlobal.apps[userovoCommon.ACTIVE_APP_ID].name || CV.i18n('push-notification.mobile-preview-default-app-name'),
        ...
        computed: {
            ...
            titlePreviewComponentsList: function() {
                return userovoPushNotification.helper.getPreviewMessageComponentsList(this.title);
            },
            contentPreviewComponentsList: function() {
                return userovoPushNotification.helper.getPreviewMessageComponentsList(this.content);
            },
            ...
            hasAndroidPlatform: function() {
                return this.isPlatformFound(userovoPushNotification.service.PlatformEnum.ANDROID);
            },
            hasIOSPlatform: function() {
                return this.isPlatformFound(userovoPushNotification.service.PlatformEnum.IOS);
            },
        },
        watch: {
            platforms: function() {
        ...
        methods: {
            ...
            findInitialSelectedPlatform: function() {
                if (this.isPlatformFound(userovoPushNotification.service.PlatformEnum.IOS)) {
                    return userovoPushNotification.service.PlatformEnum.IOS;
                }
                if (this.isPlatformFound(userovoPushNotification.service.PlatformEnum.ANDROID)) {
                    return userovoPushNotification.service.PlatformEnum.ANDROID;
                }
                return null;
            },
    ...
    userovoPushNotificationComponent.EmojiPicker = userovoVue.views.create({
        props: {
            search: {
                type: String,
                required: false,
            ...
            emojiTable: {
                ...
                required: false,
                default: function() {
                    return userovoPushNotification.emojis;
                },
            },
        },
        data: function() {
    ...
    userovoPushNotificationComponent.MessageEditorWithEmojiPicker = userovoVue.views.create({
        ...
        components: {
            'emoji-picker': userovoPushNotificationComponent.EmojiPicker,
            'add-user-property-popover': userovoPushNotificationComponent.AddUserPropertyPopover,
        },
    });

    userovoPushNotificationComponent.DetailsTabRow = userovoVue.views.create({
    ...
    userovoPushNotificationComponent.DetailsMessageTab = userovoVue.views.create({
        ...
        computed: {
            ...
            selectedMessageLocale: {
                ...
                set: function(value) {
                    this.$store.dispatch("userovoPushNotificationDetails/onSetMessageLocaleFilter", value);
                }
            },
            message: function() {
                return this.$store.state.userovoPushNotificationDetails.pushNotification.message[this.selectedMessageLocale];
            },
            localizations: function() {
                return this.$store.state.userovoPushNotificationDetails.pushNotification.localizations;
            },
            previewMessageTitle: function() {
                if (this.message.title) {
                    return userovoPushNotification.helper.getPreviewMessageComponentsList(this.message.title);
                }
                return "";
            },
            previewMessageContent: function() {
                if (this.message.content) {
                    return userovoPushNotification.helper.getPreviewMessageComponentsList(this.message.content);
                }
                return "";
            },
            ...
            selectedMobileMessagePlatform: function() {
                return this.$store.state.userovoPushNotificationDetails.mobileMessagePlatform;
            }
        },
        methods: {
        ...
        components: {
            'user-property-preview': userovoPushNotificationComponent.UserPropertyPreview,
            'user-property-text-preview': userovoPushNotificationComponent.UserPropertyTextPreview,
            'details-tab-row': userovoPushNotificationComponent.DetailsTabRow
        }
    });

    userovoPushNotificationComponent.DetailsTargetingTab = userovoVue.views.create({
        ...
        methods: {
            ...
            formatDateAndTime: function(date) {
                return userovoPushNotification.helper.formatDateTime(date, 'MMMM Do, YYYY, h:mm a');
            },
            ...
            fetchCohorts: function() {
                ...
                userovoPushNotification.service.fetchCohorts(cohortsList, false)
            ...
            fetchLocations: function() {
                ...
                userovoPushNotification.service.fetchLocations(this.pushNotification.locations, false)
    ...
    userovoPushNotificationComponent.DetailsErrorsTab = userovoVue.views.create({
        template: '#details-errors-tab',
        computed: {
            globalError: function() {
                return this.$store.state.userovoPushNotificationDetails.pushNotification.error;
            },
            errors: function() {
                if (this.globalError) {
                    var allErrors = this.$store.state.userovoPushNotificationDetails.pushNotification.errors;
                    var copyErrors = allErrors.concat([]);
                    copyErrors.unshift(this.globalError);
                    return copyErrors;
                }
                return this.$store.state.userovoPushNotificationDetails.pushNotification.errors;
            },
        }
    });

})(window.userovoPushNotificationComponent = window.userovoPushNotificationComponent || {});