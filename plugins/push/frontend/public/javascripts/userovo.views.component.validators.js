/*global VeeValidate,userovoPushNotification*/
(function() {
    var PushNotificationMessageMediaURLValidator = {
        ...
        isImageFile: function(metadata) {
            return metadata.type === userovoPushNotification.service.MediaTypeEnum.IMAGE;
        },
        isVideoFile: function(metadata) {
            return metadata.type === userovoPushNotification.service.MediaTypeEnum.VIDEO;
        },
        ...
        validateMediaByPlatform: function(platform, metadata) {
            if (platform === userovoPushNotification.service.PlatformEnum.ALL || platform === userovoPushNotification.service.PlatformEnum.ANDROID) {
                return this.validateMediaOnAll(metadata);
            }
            if (platform === userovoPushNotification.service.PlatformEnum.IOS) {
        ...
        isValid: function(url, platform) {
            ...
            return new Promise(function(resolve) {
                userovoPushNotification.service.fetchMediaMetadataWithDebounce(url,
                    function(metadata) {
