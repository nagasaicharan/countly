/*global userovoCommon, userovoVue, CV, app, userovoGlobal */

(function(userovoRemoteConfig) {
    userovoRemoteConfig.factory = {
        parameters: {
            getEmpty: function() {
                return {
                    parameter_key: "",
    ...
    userovoRemoteConfig.service = {
        ...
        createParameter: function(parameter) {
            return CV.$.ajax({
                type: "POST",
                url: userovoCommon.API_PARTS.data.w + "/remote-config/add-parameter",
                data: {
                    app_id: userovoCommon.ACTIVE_APP_ID,
        ...
        updateParameter: function(id, parameter) {
            return CV.$.ajax({
                type: "POST",
                url: userovoCommon.API_PARTS.data.w + "/remote-config/update-parameter",
                data: {
                    app_id: userovoCommon.ACTIVE_APP_ID,
                    parameter_id: id,
                    parameter: JSON.stringify(parameter)
        ...
        removeParameter: function(id) {
            return CV.$.ajax({
                type: "POST",
                url: userovoCommon.API_PARTS.data.w + "/remote-config/remove-parameter",
                data: {
                    app_id: userovoCommon.ACTIVE_APP_ID,
                    parameter_id: id
                },
        ...
        createCondition: function(condition) {
            return CV.$.ajax({
                type: "POST",
                url: userovoCommon.API_PARTS.data.w + "/remote-config/add-condition",
                data: {
                    app_id: userovoCommon.ACTIVE_APP_ID,
        ...
        updateCondition: function(id, condition) {
            return CV.$.ajax({
                type: "POST",
                url: userovoCommon.API_PARTS.data.w + "/remote-config/update-condition",
                data: {
                    app_id: userovoCommon.ACTIVE_APP_ID,
                    condition_id: id,
                    condition: JSON.stringify(condition)
        ...
        removeCondition: function(id) {
            return CV.$.ajax({
                type: "POST",
                url: userovoCommon.API_PARTS.data.w + "/remote-config/remove-condition",
                data: {
                    app_id: userovoCommon.ACTIVE_APP_ID,
                    condition_id: id
                },
        ...
        addCompleteConfig: function(settings) {
            return CV.$.ajax({
                type: "POST",
                url: userovoCommon.API_PARTS.data.w + "/remote-config/add-complete-config",
                data: {
                    "app_id": userovoCommon.ACTIVE_APP_ID,
    ...
    userovoRemoteConfig.getVuexModule = function() {
        var actions = {
            initialize: function(context) {
                return userovoRemoteConfig.service.initialize().then(function(res) {
                    if (res) {
                        if (res && userovoGlobal.plugins.indexOf("ab-testing") > -1) {
                            userovoRemoteConfig.service.getAb().then(function(resp) {
                                ...
                                if (resp) {
                                    ...
                                    context.dispatch("userovoRemoteConfig/parameters/all", parameters, {root: true});
                                    context.dispatch("userovoRemoteConfig/conditions/all", conditions, {root: true});
                                }
                            });
                        }
                        else {
        ...
        var parametersResource = userovoVue.vuex.Module("parameters", {
            state: function() {
                return {
                    all: [],
            ...
            actions: {
                ...
                create: function(context, parameter) {
                    return userovoRemoteConfig.service.createParameter(parameter).then(function() {
                ...
                update: function(context, parameter) {
                    ...
                    return userovoRemoteConfig.service.updateParameter(id, updateParameter);
                },
                remove: function(context, parameter) {
                    return userovoRemoteConfig.service.removeParameter(parameter._id);
                },
        ...
        var conditionsResource = userovoVue.vuex.Module("conditions", {
            state: function() {
                return {
                    all: [],
                    isTableLoading: true,
            ...
            actions: {
                ...
                create: function(context, condition) {
                    return userovoRemoteConfig.service.createCondition(condition).catch(function(err) {
                ...
                update: function(context, condition) {
                    ...
                    return userovoRemoteConfig.service.updateCondition(id, condition);
                },
                remove: function(context, condition) {
                    return userovoRemoteConfig.service.removeCondition(condition._id);
                },
                setTableLoading: function(context, value) {
                    context.commit("setTableLoading", value);
                }
        ...
        return userovoVue.vuex.Module("userovoRemoteConfig", {
            actions: actions,
            submodules: [parametersResource, conditionsResource]
        });
    };

})(window.userovoRemoteConfig = window.userovoRemoteConfig || {});
