/*global _, VeeValidate, userovoQueryBuilder, app, moment, userovoGlobal, userovoVue, userovoCommon, userovoAuth, CV, UserovoHelpers, userovoRemoteConfig */

(function() {
    var FEATURE_NAME = "remote_config";
    var _mixins = userovoVue.mixins;
    ...
    var ConditionStats = userovoVue.views.BaseView.extend({
        ...
        computed: {
            isDrillEnabled: function() {
                return userovoGlobal.plugins.indexOf("drill") > -1 ? true : false;
            },
            conditions: function() {
                var conditions = [];
                var allConditions = this.$store.getters["userovoRemoteConfig/conditions/all"];
                var self = this;
    ...
    var JsonEditor = userovoVue.views.create({
        ...
        methods: {
            handleClose: function() {
                this.$store.dispatch("userovoRemoteConfig/parameters/showJsonEditor", false);
                this.$store.dispatch("userovoRemoteConfig/parameters/showJsonEditorForCondition", false);
                this.$emit("input", this.currentVal);
            }
        }
    });
    var ConditionDialog = userovoVue.views.create({
        ...
        data: function() {
            ...
            var remoteConfigFilterRules = [new userovoQueryBuilder.RowRule({
            ...
            additionalProperties.push(new userovoQueryBuilder.Property({
            ...
            return {
                ...
                colorTag: COLOR_TAG,
                modifyPropType: { 'up.av': userovoQueryBuilder.PropertyType.APP_VERSION_LIST },
            };
        },
        computed: {
            isOpen: function() {
                return this.$store.getters["userovoRemoteConfig/parameters/showConditionDialog"];
            },
        ...
        methods: {
            submit: function() {
                ...
                var action = "userovoRemoteConfig/conditions/create";
                ...
                this.$store.dispatch(action, this.conditionDialog).then(function(data) {
                    if (data) {
                        ...
                        UserovoHelpers.notify({
                            ...
                            message: self.$store.getters["userovoRemoteConfig/conditions/conditionError"],
                            type: "error"
                        });
                    }
                });
                this.$store.dispatch("userovoRemoteConfig/parameters/showConditionDialog", false);
            },
            cancel: function() {
                this.$store.dispatch("userovoRemoteConfig/parameters/showConditionDialog", false);
            },
    ...
    var CreateConditionInput = userovoVue.views.create({
        ...
        computed: {
            ...
            isOpen: function() {
                var val = this.$store.getters["userovoRemoteConfig/parameters/showJsonEditorForCondition"];
        ...
        methods: {
            ...
            openJsonEditorForCondition: function() {
                ...
                this.$store.dispatch("userovoRemoteConfig/parameters/showJsonEditorForCondition", true);
            }
        }
    });
    var ParametersDrawer = userovoVue.views.create({
        ...
        computed: {
            isOpen: function() {
                return this.$store.getters["userovoRemoteConfig/parameters/showJsonEditor"];
            },
            isDrillEnabled: function() {
                return userovoGlobal.plugins.indexOf("drill") > -1 ? true : false;
            },
            conditionArray: function() {
                var conditions = this.$store.getters["userovoRemoteConfig/conditions/all"];
                var ob = [];
        ...
        methods: {
            ...
            getOffset: function() {
                var activeAppId = userovoCommon.ACTIVE_APP_ID;
                var timeZone = userovoGlobal.apps[activeAppId].timezone ? userovoGlobal.apps[activeAppId].timezone : 'UTC';
            ...
            handleSelect: function(item) {
                ...
                if (userovoGlobal.conditions_per_paramaeters === this.conditions.length) {
                    UserovoHelpers.notify({
                        title: CV.i18n("common.error"),
            ...
            onSubmit: function(doc) {
                ...
                var action = "userovoRemoteConfig/parameters/create";
                if (doc._id) {
                    action = "userovoRemoteConfig/parameters/update";
                }
            ...
            openJsonEditor: function() {
                this.$store.dispatch("userovoRemoteConfig/parameters/showJsonEditor", true);
            },
            ...
            showConditionDialog: function() {
                ...
                this.$store.dispatch("userovoRemoteConfig/parameters/showConditionDialog", true);
            },
    ...
    var ConditionsDrawer = userovoVue.views.create({
        ...
        methods: {
            ...
            onSubmit: function(doc) {
                ...
                var action = "userovoRemoteConfig/conditions/create";
                if (doc._id) {
                    action = "userovoRemoteConfig/conditions/update";
                }
    ...
    var ParametersComponent = userovoVue.views.BaseView.extend({
        template: "#remote-config-parameters",
        mixins: [userovoVue.mixins.hasDrawers("parameters")],
        components: {
        ...
        computed: {
            ...
            tableRows: function() {
                return this.$store.getters["userovoRemoteConfig/parameters/all"];
            },
            isParamterLimitExceeded: function() {
                return userovoGlobal.maximum_allowed_parameters === this.$store.getters["userovoRemoteConfig/parameters/all"].length ? true : false;
            },
            hasUpdateRight: function() {
                return userovoAuth.validateUpdate(FEATURE_NAME);
            },
            ...
            isTableLoading: function() {
                return this.$store.getters["userovoRemoteConfig/parameters/isTableLoading"];
            }
        },
        methods: {
            ...
            create: function() {
                this.openDrawer("parameters", userovoRemoteConfig.factory.parameters.getEmpty());
            },
            toggleParameterState(rowObj, status) {
                ...
                row.status = status;
                this.$store.dispatch("userovoRemoteConfig/parameters/update", row).then(function() {
                    refresh();
                });
            },
            handleCommand: function(command, scope, row) {
                ...
                case "remove":
                    UserovoHelpers.confirm(this.i18n("remote-config.confirm-parameter-delete", "<b>" + row.parameter_key + "</b>"), "popStyleGreen", function(result) {
                        if (!result) {
                            return false;
                        }

                        self.$store.dispatch("userovoRemoteConfig/parameters/remove", row).then(function() {
                            self.onSubmit();
                        });
            ...
            formatExportFunction: function() {
                var tableData = this.$store.getters["userovoRemoteConfig/parameters/all"];
                var table = [];
                for (var i = 0; i < tableData.length; i++) {
                    ...
                    item[CV.i18n('remote-config.parameter.created').toUpperCase()] = userovoCommon.formatTimeAgoText(tableData[i].ts).text;
            ...
            refresh: function() {
                this.$store.dispatch("userovoRemoteConfig/initialize");
            },
        },
        created: function() {
            this.$store.dispatch("userovoRemoteConfig/parameters/setTableLoading", true);
        },
    });

    var ConditionsComponent = userovoVue.views.BaseView.extend({
        template: "#remote-config-conditions",
        mixins: [userovoVue.mixins.hasDrawers("conditions")],
        components: {
            drawer: ConditionsDrawer
        },
        computed: {
            tableRows: function() {
                return this.$store.getters["userovoRemoteConfig/conditions/all"];
            },
            hasUpdateRight: function() {
                return userovoAuth.validateUpdate(FEATURE_NAME);
            },
            ...
            isTableLoading: function() {
                return this.$store.getters["userovoRemoteConfig/conditions/isTableLoading"];
            }
        },
        methods: {
            displayDescription: function(description) {
            ...
            create: function() {
                this.openDrawer("conditions", userovoRemoteConfig.factory.conditions.getEmpty());
            },
            handleCommand: function(command, scope, row) {
                var self = this;
                ...
                case "remove":
                    UserovoHelpers.confirm(this.i18n("remote-config.confirm-condition-delete", "<b>" + row.condition_name + "</b>"), "popStyleGreen", function(result) {
                        if (!result) {
                            return false;
                        }

                        self.$store.dispatch("userovoRemoteConfig/conditions/remove", row).then(function() {
                            self.onSubmit();
                        });
    ...
    var MainComponent = userovoVue.views.BaseView.extend({
        ...
        data: function() {
            var tabs = [
                {
                    ...
                    route: "#/" + userovoCommon.ACTIVE_APP_ID + "/remote-config/parameters"
                }
            ];
            if (userovoGlobal.plugins.indexOf("drill") > -1) {
                tabs.push({
                    ...
                    route: "#/" + userovoCommon.ACTIVE_APP_ID + "/remote-config/conditions"
                });
            }
            return {
        ...
        beforeCreate: function() {
            var self = this;
            this.$store.dispatch("userovoRemoteConfig/initialize").then(function() {
                self.$store.dispatch("userovoRemoteConfig/conditions/setTableLoading", false);
            });
        },
        methods: {
            refresh: function() {
