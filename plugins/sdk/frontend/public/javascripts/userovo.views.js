/*global app, userovoVue, userovoSDK, CV, userovoCommon*/
(function() {
    var FEATURE_NAME = "sdk";
    var SDK = userovoVue.views.create({
        template: CV.T('/sdk/templates/sdk-main.html'),
        mixins: [
            userovoVue.container.tabsMixin({
                "sdkTabs": "/manage/sdk"
            })
        ].concat(userovoVue.container.mixins(["/manage/sdk"])),
        data: function() {
            return {
    ...
    var getSDKMainView = function() {
        var tabsVuex = userovoVue.container.tabsVuex(["/manage/sdk"]);
    ...
    var SDKConfigurationView = userovoVue.views.create({
        template: CV.T('/sdk/templates/config.html'),
        created: function() {
            var self = this;
            this.$store.dispatch("userovoSDK/initialize").then(function() {
                self.$store.dispatch("userovoSDK/sdk/setTableLoading", false);
            });
        },
        computed: {
            getData: function() {
                var params = this.$store.getters["userovoSDK/sdk/all"];
                var data = params || {};
            ...
            isTableLoading: function() {
                return this.$store.getters["userovoSDK/sdk/isTableLoading"];
            }
        },
        data: function() {
            return {
        ...
        methods: {
            ...
            save: function() {
                ...
                this.diff = [];
                var self = this;
                this.$store.dispatch("userovoSDK/sdk/update", data).then(function() {
                    self.$store.dispatch("userovoSDK/initialize");
                });
            },
            unpatch: function() {
                this.diff = [];
    ...
    userovoVue.container.registerTab("/manage/sdk", {
        priority: 2,
    ...
    var SDKStatsView = userovoVue.views.create({
                ...
                sdkTabs: [
                    {
                        ...
                        component: userovoVue.views.create({
                            ...
                            computed: {
                                sdk: function() {
                                    return this.$store.state.userovoSDK.stats.sdk;
                                },
                                sdkRows: function() {
                                    return this.sdk.chartData;
                                },
                                isLoading: function() {
                                    return this.$store.state.userovoSDK.stats.isLoading;
                                }
                            },
                            methods: {
                    ...
                    },
                    {
                        ...
                        component: userovoVue.views.create({
                            ...
                            computed: {
                                ...
                                selectedSDK: {
                                    set: function(value) {
                                        this.$store.dispatch('userovoSDK/onSetSelectedSDK', value);
                                    },
                                    get: function() {
                                        return this.$store.state.userovoSDK.stats.selectedSDK;
                                    }
                                }
                            },
                            watch: {
                            ...
                            methods: {
                                calculateVersions: function(newValue) {
                                    if (newValue) {
                                        this.$store.dispatch('userovoSDK/onSetSelectedSDK', newValue);
                                    }
                                    else {
                                        this.selectedSDK = this.sdk.versions[0].label;
                                        this.$store.dispatch('userovoSDK/onSetSelectedSDK', this.selectedSDK);
                                    }
        ...
        mounted: function() {
            this.$store.dispatch('userovoSDK/fetchSDKStats');
        },
        methods: {
            refresh: function() {
                this.$store.dispatch('userovoSDK/fetchSDKStats');
        ...
        watch: {
            selectedSDK: function(newValue) {
                if (newValue) {
                    ...
                    this.selectedSDK = this.$store.state.userovoSDK.stats.sdk.versions[0].label;
                    this.$store.dispatch('userovoSDK/onSetSelectedSDK', this.selectedSDK);
                }
                var tempVersions = [];
                for (var k = 0; k < this.$store.state.userovoSDK.stats.sdk.versions.length; k++) {
                    tempVersions.push({"value": this.$store.state.userovoSDK.stats.sdk.versions[k].label, "name": this.$store.state.userovoSDK.stats.sdk.versions[k].label});
                }
                this.versions = tempVersions;
            }
        },
        computed: {
            ...
            selectedProperty: {
                set: function(value) {
                    this.$store.dispatch('userovoSDK/onSetSelectedProperty', value);
                },
                get: function() {
                    return this.$store.state.userovoSDK.stats.selectedProperty;
                }
            },
            selectedDisplay: {
                set: function(value) {
                    this.$store.dispatch('userovoSDK/onSetSelectedDisplay', value);
                },
                get: function() {
                    return this.$store.state.userovoSDK.stats.selectedDisplay;
                }
            },
            selectedSDK: {
                set: function(value) {
            ...
            stats: function() {
                return this.$store.state.userovoSDK.stats;
            },
            sdk: function() {
            ...
            sdkItems: function() {
                var display = [];
                var property = this.$store.state.userovoSDK.stats.selectedProperty;
                ...
                for (var k = 0; k < data.length; k++) {
                    ...
                    display.push({
                        "name": data[k].sdks,
                        "value": userovoCommon.getShortNumber(data[k][property] || 0),
                        "percent": percent,
                ...
                for (var z = 0; z < sdks.length; z++) {
                    ...
                    for (var k = 0; k < data.length; k++) {
                        ...
                        display.push({
                            ...
                            "description": userovoCommon.getShortNumber(data[k][property] || 0),
                            "percent": percent,
                            "bar": [{
                                percentage: percent,
    ...
    var SDKReqStatsView = userovoVue.views.create({
    ...
    var SDKHealthCheckView = userovoVue.views.create({
