/*global userovoCommon,CV,userovoVue,userovoEvent,moment*/
(function(userovoTimesOfDay) {

    userovoTimesOfDay.service = {
        ...
        findEventKeyByName: function(name) {
            return userovoEvent.getEvents().find(function(item) {
                return item.name === name;
            });
        },
        getEventOptions: function() {
            return userovoEvent.getEvents().map(function(event) {
    ...
    userovoTimesOfDay.getVuexModule = function() {
        ...
        var getInitialState = function() {
            return {
                ...
                series: [],
                filters: {
                    dateBucketValue: userovoTimesOfDay.service.DateBucketEnum.ALL_TIME,
        ...
        var userovoTimesOfDayMutations = {
        ...
        var userovoTimesOfDayGetters = {
            loading: function(state) {
                return state.loading;
            }
        };
        return userovoVue.vuex.Module("userovoTimesOfDay", {
            state: getInitialState,
            actions: userovoTimesOfDayActions,
            mutations: userovoTimesOfDayMutations,
            getters: userovoTimesOfDayGetters,
            submodules: [userovoVue.vuex.FetchMixin()]
        });
    };

}(window.userovoTimesOfDay = window.userovoTimesOfDay || {}));