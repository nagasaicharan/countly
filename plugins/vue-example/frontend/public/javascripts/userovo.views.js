/*global app, userovoVue, userovoVueExample, userovoCommon, CV, moment */

(function() {
    var TableView = userovoVue.views.create({
        template: CV.T('/vue-example/templates/table.html'),
        computed: {
            tableRows: function() {
                return this.$store.getters["userovoVueExample/myRecords/all"];
            },
            rTableData: function() {
                return this.tableStore.getters.tooManyRecords;
            },
            remoteTableDataSource: function() {
                return userovoVue.vuex.getServerDataSource(this.tableStore, "tooManyRecords");
            },
        },
        data: function() {
            var tableStore = userovoVue.vuex.getLocalStore(userovoVue.vuex.ServerDataTable("tooManyRecords", {
                columns: ['_id', "name"],
                onRequest: function(context) {
                    return {
                        type: "GET",
                        url: userovoCommon.API_URL + "/o",
                        data: {
            ...
            return {
                ...
                tablePersistKey: "vueExample_localTable_" + userovoCommon.ACTIVE_APP_ID,
                remoteTablePersistKey: "vueExample_remoteTable_" + userovoCommon.ACTIVE_APP_ID,
            };
        },
        beforeCreate: function() {
            this.$store.dispatch("userovoVueExample/initializeTable");
        },
        methods: {
            refresh: function() {
                this.$store.dispatch("userovoVueExample/myRecords/fetchAll");
            },
            onEditRecord: function(row) {
                var self = this;
                this.$store.dispatch("userovoVueExample/myRecords/fetchSingle", row._id).then(function(doc) {
                    self.$emit("open-drawer", "main", doc);
                });
            },
            onDelete: function(row) {
                this.$store.dispatch("userovoVueExample/myRecords/remove", row._id);
            }
        }
    });

    var FormBasics = userovoVue.views.BaseView.extend({
    ...
    var FormDropdown = userovoVue.views.BaseView.extend({
    ...
    var TimeGraphView = userovoVue.views.create({
        ...
        computed: {
            ...
            barData: function() {
                return this.$store.getters["userovoVueExample/barData"];
            },
            lineData: function() {
                return this.$store.getters["userovoVueExample/lineData"];
            },
        ...
        beforeCreate: function() {
            this.$store.dispatch("userovoVueExample/fetchGraphPoints");
        },
        methods: {
    ...
    var ExampleDrawer = userovoVue.views.create({
        ...
        methods: {
            onSubmit: function(doc) {
                this.$store.dispatch("userovoVueExample/myRecords/save", doc);
            },
    ...
    var DateView = userovoVue.views.create({
    ...
    var ProgressBarsView = userovoVue.views.create({
    ...
    var MetricCardsView = userovoVue.views.create({
    ...
    userovoVue.container.registerMixin("vue/example", {
        data: function() {
            return {
                myname: "itsi"
            };
        ...
        beforeCreate: function() {
            // userovoVueExample.service.fetchRandomNumbers().then(function() {
    ...
    var AllTablesView = userovoVue.views.create({
        template: CV.T('/vue-example/templates/tables.html'),
        mixins: [userovoVue.mixins.hasDrawers("main")],
        data: function() {
            return {
                ...
                localTabs: [
                    {
                        ...
                        name: "local-table",
                        component: TableView,
                        // route: "#/" + userovoCommon.ACTIVE_APP_ID + "/vue/example/tables/all"
                    },
                    {
                        title: "Dummy table",
                        name: "dummy-table",
                        component: userovoVue.views.create({
        ...
        methods: {
            add: function() {
                this.openDrawer("main", userovoVueExample.factory.getEmpty());
            }
        }
    });
    ...
    var MainView = userovoVue.views.create({
        ...
        ].concat(userovoVue.container.mixins(["vue/example"])),
        data: function() {
            return {
                appId: userovoCommon.ACTIVE_APP_ID,
                ...
                localTabs: [
                    {
                        ...
                        route: "#/" + userovoCommon.ACTIVE_APP_ID + "/vue/example/tables"
                    },
                    {
                        title: "Form: Basic",
                        name: "form-basic",
                        component: FormBasics,
                        route: "#/" + userovoCommon.ACTIVE_APP_ID + "/vue/example/form-basic"
                    },
                    {
                        title: "Form: Dropdown",
                        name: "form-dropdown",
                        component: FormDropdown,
                        route: "#/" + userovoCommon.ACTIVE_APP_ID + "/vue/example/form-dropdown"
                    },
                    {
                        title: "Metric Cards",
                        name: "metric-cards",
                        component: MetricCardsView,
                        route: "#/" + userovoCommon.ACTIVE_APP_ID + "/vue/example/metric-cards"
                    },
                    {
                        title: "Charts",
                        name: "charts",
                        component: TimeGraphView,
                        route: "#/" + userovoCommon.ACTIVE_APP_ID + "/vue/example/charts"
                    },
                    {
                        title: "Date",
                        name: "date",
                        component: DateView,
                        route: "#/" + userovoCommon.ACTIVE_APP_ID + "/vue/example/date"
                    },
                    {
                        title: "Progress bars",
                        name: "progress-bars",
                        component: ProgressBarsView,
                        route: "#/" + userovoCommon.ACTIVE_APP_ID + "/vue/example/progress-bars"
                    }
                ]
            };
        },
    ...
    var getMainView = function() {
        ...
        var tabsVuex = userovoVue.container.tabsVuex(["vue/example"]);
    ...
    userovoVue.container.registerTab("vue/example", {
        priority: 1,
        ...
        component: userovoVue.components.create({
            data: function() {
                return {
                    localStore: userovoVue.vuex.getLocalStore(window.foo.getVuexModule())
                };
            },
            computed: {
                message: function() {
