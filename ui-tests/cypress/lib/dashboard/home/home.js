const homePageElements = require("../../../support/elements/dashboard/home/home");
...
const verifyStaticElementsOfPage = () => {
    ...
    cy.verifyElement({
        ...
        tooltipText: "The number of write API requests the Userovo Server receives for each session (includes sessions, session extensions, events, etc.)."
    });
